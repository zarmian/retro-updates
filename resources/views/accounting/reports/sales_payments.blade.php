  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1>@lang('admin/reports.sales_payments_report_txt') </h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right"><a href="{{ url('/') }}">@lang('admin/dashboard.dashboard-heading')</a>  / <a href="#" class="active">@lang('admin/reports.sales_payments_report_txt')</a></div>
    </div>
  </div>
</section>
@endsection
...
<section class="find-search hidden-print">
  <div class="container">
    ...
    <form action="{{ url('/reports/sales-payments') }}" method="post">
      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-10 no-padding">
          ...
          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
           ...
           <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 filter-dropdown">
            ...
            <select name="customer" id="customer" class="chosen form-control1">
              <option value="">@lang('admin/reports.select_by_customer_option_txt')</option>
              @if(isset($customers)  )
          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 filter-input">
            <input type="text" name="voucher_no" id="voucher_no" class="filter-date-input" placeholder="@lang('admin/reports.invoice_no_txt')" value="{{ app('request')->input('voucher_no') }}" />
           </div>
      ...
      <div id="products" class="row list-group">
        ...
        <div class="ac_chart">
          ...
          <table class="table table-striped">
              ...
              <div class="col-sm-9">
                <div class="reports-breads"><h2><b>@lang('admin/reports.sales_payments_report_txt')</b> <span class="filter-txt-highligh">({{ $to_date }} - {{ $from_date }}) </span>@if(!empty($voucher_no)) @lang('admin/reports.for_search_invoice_txt') <span class="filter-txt-highligh">({{$voucher_no}})</span> @endif</h2></div>
              </div>
              ...
              <div class="col-sm-3 text-center pull-right hidden-print">
                ...
                <div class="col-sm-5 no-padding-left pull-right"><a href="{{ url("/reports/sales/export/?type=salesTransaction&to={$to}&from={$from}&customer={$customer_id}&voucher_no={$voucher_no}") }}" class="btn-default-xs btn-excel-bg btn-block"> @lang('admin/reports.export_txt') &nbsp;&nbsp; <i class="fa fa-file-excel-o" aria-hidden="true"></i></a></div>
              </div>
               
                <tr>
                  <th width="150">@lang('admin/entries.pay_serial_no_txt')</th>
                  <th width="150">@lang('admin/entries.invoice_no_txt')</th>
