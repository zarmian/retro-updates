  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active">@lang('employees/common.request_leave_create_txt')</a>
      </div>
    </div>
  </div>
</section>
...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      <form data-toggle="validator" role="form" method="post" class="registration-form"  action="{{ url('/leave-request/store') }}" style="margin-top: 20px;" enctype="multipart/form-data">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12 col-sm-offset-3 col-md-offset-3 col-sm-offset-0">
            ...
            <div class="form_container">
              ...
              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group no-padding-left">
                ...
                <input type="text" name="title" id="title" class="form-control1" placeholder="@lang('employees/common.leave_title_txt')*" required="required" value="" />
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group no-padding-left">
                ...
                <textarea name="description" id="description" cols="30" rows="10" class="form-control2"></textarea>
              </div>
