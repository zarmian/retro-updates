  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="{{ url('accounting/payments/received') }}">Recieved Voucher</a>  / 
    ...
    <div class="container">
      <div class="col-sm-12 col-md-12 col-lg-12">
        @if(Session::has('msg'))
         ...
         <form data-toggle="validator" role="form" action="{{ url('accounting/payments/received/add') }}" method="POST" enctype="multipart/form-data" class="erp-form erp-ac-transaction-form">
