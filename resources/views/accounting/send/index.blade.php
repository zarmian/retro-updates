    ...
    <div class="row">
      ...
      <form action="" method="GET">
       ...
       <div class="col-lg-1 col-md-1 col-sm-2 col-xs-12 plus-margin">
        ...
        <a href="{{ url('accounting/payments/send/add') }}" class="plus">+</a></div>
      ...
      <div id="products" class="list-group">
        ...
        @foreach($journals as $journal)
          ...
          <div class="col-lg-1 col-sm-12 col-xs-12 no-padding">
              ...
              <div class="col-sm-6 no-padding"><a href="{{ url('accounting/payments/send/detail/'.$journal['id']) }}" class="payment-btn-list btn-block btn-gray-bg"><i class="fa fa-eye" aria-hidden="true"></i></a>
              </div>
              <div class="col-sm-6 no-padding"><a href="{{ url('accounting/payments/send/edit/'.$journal['id']) }}" class="payment-btn-list btn-block btn-blue-bg"><i class="fa fa-edit" aria-hidden="true"></i></a></div>
