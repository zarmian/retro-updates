  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="{{ url('/loan-request') }}">@lang('employees/common.request_loan_txt')</a>  /  
...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      <form data-toggle="validator" role="form" method="post" class="registration-form"  action="{{ url('/loan-request/store') }}" style="margin-top: 20px;" enctype="multipart/form-data">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12 col-sm-offset-3 col-md-offset-3 col-sm-offset-0">
            ...
            <div class="form_container">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding-left">
                ...
                <input type="text" name="title" id="title" class="form-control1" placeholder="@lang('employees/common.loan_title_txt')*" required="required" value="" />
              </div>

              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding-left">
                <label for="date" class="input_label">@lang('employees/common.loan_apply_date')</label>
                <input type="text" name="date" id="date" class="datepicker form-control1" placeholder="@lang('employees/common.loan_apply_date')*" required="required" value="" />
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group no-padding-left">
                ...
                <input type="text" name="amount" id="amount" class="form-control1" placeholder="@lang('employees/common.loan_amount')*" required="required" value="" />
              </div>

              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group no-padding-left">
                <label for="reason" class="input_label">@lang('employees/common.loan_reason')</label>
                <textarea name="reason" id="reason" cols="30" rows="10" class="form-control2" placeholder="@lang('employees/common.loan_reason')"></textarea>
              </div>
