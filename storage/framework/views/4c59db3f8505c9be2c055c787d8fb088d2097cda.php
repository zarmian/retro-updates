  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="<?php echo e(url('/accounting/products')); ?>">Product</a>  / 
...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      <form data-toggle="validator" role="form" method="post" class="registration-form"  action="<?php echo e(url('/accounting/products/add')); ?>" style="margin-top: 20px;" enctype="multipart/form-data">
