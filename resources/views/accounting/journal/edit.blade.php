  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active">@lang('admin/entries.update_journal_heading')</a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="col-sm-12 col-md-12 col-lg-12">
        @if(Session::has('msg'))
         ...
         <form data-toggle="validator" role="form" action="{{ url('accounting/journal/save', $journal['id']) }}" method="POST" enctype="multipart/form-data" class="erp-form erp-ac-transaction-form">
          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-xs-12 col-sm-offset-2">
            <div class="top_content">
              <h3>@lang('admin/entries.update_journal_heading')</h3>
                      ...
                      @foreach($journal['details'] as $detail)
                        ...
                        <tr>
                          <td class="col-chart" width="250" height="50">
                            ...
                            @if(isset($detail) && $detail['types'] == 15)
