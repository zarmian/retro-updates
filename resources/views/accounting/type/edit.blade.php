  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1>@lang('admin/accounting.account_type_edit_txt')</h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active">@lang('admin/accounting.account_type_edit_txt')</a>
      </div>
    </div>
  </div>
</section>
...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      <form data-toggle="validator" role="form" method="post" class="registration-form"  action="{{ url('accounting/chart-type/edit', $account->id) }}" style="margin-top: 20px;" enctype="multipart/form-data">
        ...
        <div class="form_container">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12 col-sm-offset-3 col-md-offset-3 col-sm-offset-0">
            <div class="top_content">
              <h3>@lang('admin/accounting.account_type_edit_txt')</h3>
            ...
            <div class="form_container">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <input type="text" name="name" id="name" class="form-control1" placeholder="@lang('admin/accounting.account_type_title')*" required="required" value="{{ $account->name }}" />
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group">
                ...
                <select name="parent" id="parent" data-placeholder="Choose a Types" class="chosen-deselect form-control1" tabindex="2">
                  ...
                  @if(isset($types) )
                    ...
                    @else
                      <option value="0">{{ $type['name'] }}</option>
                    @endif
