          ...
          <table class="table table-striped">
              ...
              <div class="col-sm-3 text-center pull-right hidden-print">
                ...
                <tr>
                  ...
                  <th width="150" align="right" style="text-align: right;" width="100"><?php echo app('translator')->getFromJson('admin/entries.tlt_txt'); ?></th>
                ...
                <td align="right"><b><?php echo app('translator')->getFromJson('admin/reports.tlt_amount_txt'); ?></b></td>
