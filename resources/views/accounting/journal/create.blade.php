  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active">@lang('admin/entries.create_journal_heading')</a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="col-sm-12 col-md-12 col-lg-12">
        @if(Session::has('msg'))
         ...
         <form data-toggle="validator" role="form" action="{{ url('accounting/journal/save') }}" method="POST" enctype="multipart/form-data" class="erp-form erp-ac-transaction-form">
          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-xs-12 col-sm-offset-2">
            <div class="top_content">
              <h3>@lang('admin/entries.journal_heading_txt')</h3>
            ...
            <div class="form_container">
                ...
                <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4 form-group">
                  <label for="invoice_no" class="input_label">@lang('admin/entries.entry_code_txt')*</label>
                  ...
                  <table class="erp-table erp-ac-transaction-table journal-table">
                    ...
                    <input type="hidden" value="0" name="id" id="id">                    
                      ...
                      <td class="col-chart" width="250" height="50">
                          ...
                          <option value=""> @lang('admin/entries.select_option_exp_account_value') </option>
                          @if(isset($accounts)  )
