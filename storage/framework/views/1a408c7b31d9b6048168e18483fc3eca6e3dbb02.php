                  ...
                  <li>
                    <div class="caption">
                      <ul>
                        ...
                        <li class="name">Price: <b> <?php echo e($item['price']); ?></li>
                      </ul>
                    </div>
                  </li>
                </ul>
                <ul class="inner-btn clearfix">
                  <li><a href="<?php echo e(url('accounting/items/edit/'.$item['id'])); ?>" data-toggle="tooltip" title="Edit"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></li>
