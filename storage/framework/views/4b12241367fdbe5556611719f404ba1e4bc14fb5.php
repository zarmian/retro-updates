  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/entries.update_ib_heading'); ?></a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="col-sm-12 col-md-12 col-lg-12">
        <?php if(Session::has('msg')): ?>
         ...
         <form data-toggle="validator" role="form" action="<?php echo e(url('accounting/interbank/update', $transfer['id'])); ?>" method="POST" enctype="multipart/form-data" class="erp-form erp-ac-transaction-form">
          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-xs-12 col-sm-offset-2">
            <div class="top_content">
              <h3><?php echo app('translator')->getFromJson('admin/entries.update_ib_heading'); ?></h3>
            ...
            <div class="form_container">
                ...
                <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4 form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="code" id="code" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/entries.ib_entry_code_txt'); ?>*" value="<?php echo e($transfer['code']); ?>" required="required" readonly="readonly" style="border-bottom-left-radius: 0px;border-top-left-radius: 0px; background: #e0e0e0;" />
                  </div>
                      ...
                      <td class="col-chart" width="250" height="50">
                          ...
                          <?php if(isset($banks) && count($banks) > 0): ?>
                            <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($bank['id'] == $transfer['account_from_id']): ?>
                        ...
                        <td class="col-chart" width="250" height="50">
                          ...
                          <?php if(isset($banks) && count($banks) > 0): ?>
                            <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($bank['id'] == $transfer['account_to_id']): ?>
                              <option value="<?php echo e($bank['id']); ?>" selected="selected"><?php echo e($bank['code']); ?> -- <?php echo e($bank['name']); ?></option>
                            <?php else: ?>
                              <option value="<?php echo e($bank['id']); ?>"><?php echo e($bank['code']); ?> -- <?php echo e($bank['name']); ?></option>
                            <?php endif; ?>
                        ...
                        <td class="col-amount">
                            <input type="text" value="<?php echo e($transfer['tlt_cr']); ?>" name="transfer_amount" id="transfer_amount" data-bv-callback="true" data-bv-callback-message="Wrong answer" class="line_debit form-control1" placeholder="0.00" />
                        </td>
                ...
                <textarea name="summery" id="summery" cols="30" rows="10" class="form-control2" placeholder="<?php echo app('translator')->getFromJson('admin/entries.reference_textarea_label'); ?>"><?php echo e($transfer['description']); ?></textarea>
                </div>
