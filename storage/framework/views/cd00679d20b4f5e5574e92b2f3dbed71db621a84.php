  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1><?php echo app('translator')->getFromJson('admin/employees.update_role'); ?></h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/employees.update_role'); ?></a>
      </div>
    </div>
  </div>
</section>
...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      <?php endif; ?>
      <form id="group_form" method="post" class="registration-form" action="<?php echo e(url('/roles/update', $role->id)); ?>" style="margin-top: 20px;" enctype="multipart/form-data">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
            ...
            <div class="form_container">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding">
                ...
                <input type="text" name="title" id="title" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/users.role_title_label'); ?>*" value="<?php echo e($role->title); ?>" required="required" />
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group no-padding">
                ...
                <textarea name="description" id="description" cols="30" rows="10" class="form-control2" placeholder="<?php echo app('translator')->getFromJson('admin/users.role_description_label'); ?>"><?php echo e($role->description); ?></textarea>
              </div>
           ...
           <div class="top_content">
            ...
            <div class="form_container">
              ...
              <?php if(isset($permissions) && count($permissions) > 0): ?>
                  ...
                  <?php if(isset($allowed_permissions[$permission->name]) && $allowed_permissions[$permission->name] == 'true'): ?>

                    <div class="col-sm-6 col-md-6 col-lg-6 col-xs-12 permission_margin no-padding-left">
                      <div data-toggle="buttons" class="btn-group bizmoduleselect">
                      <label class="btn permission_label active">
                        <input type="checkbox" name="permissions[<?php echo e($permission->name); ?>]" name="permissions[<?php echo e($permission->name); ?>]" autocomplete="off" value="true" checked="checked" />
