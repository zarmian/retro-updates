              ...
              <div class="invoice-top-space clearfix">
                ...
                <div class="col-sm-4 col-sm-offset-8">
                 <table class="table table-bordered total_cal" id="total_cal" style="text-align: right">
                   <tr>
                     <th width="150" class="text-right">@lang('admin/entries.sub_total_txt')</th>
                   ...
                   <tr>
                     <th class="text-right">@lang('admin/entries.total_txt')</th>
                     <td>{{ $sale['total'] }}</td>
                   </tr>

                   <tr>
                     <th class="text-right">@lang('admin/entries.total_paid_txt')</th>
