  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1>Update Send Voucher</h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        <a href="{{ url('/') }}">@lang('admin/dashboard.dashboard-heading')</a>  / 
        <a href="{{ url('accounting/payments/send') }}">Payment Send Voucher
</a>  / 
        <a href="#" class="active">Update Send Voucher</a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="col-sm-12 col-md-12 col-lg-12">
        @if(Session::has('msg'))
         ...
         <form data-toggle="validator" role="form" action="{{ url('accounting/payments/send/edit', $journal['id']) }}" method="POST" enctype="multipart/form-data" class="erp-form erp-ac-transaction-form">
          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-xs-12 col-sm-offset-2">
            <div class="top_content">
              <h3>Update Send Payment Voucher</h3>
            ...
            <div class="form_container">
                ...
                <label for="code" class="input_label">@lang('admin/entries.entry_code_txt')</label>
                <input type="text" name="code" id="code" class="form-control1" placeholder="@lang('admin/entries.entry_code_txt')" readonly="readonly" value="{{ $journal['code'] }}" />
                </div>
                      ...
                      @foreach($journal['details'] as $detail)
                        ...
                        <tr>
                          <td class="col-chart" width="250" height="50">
                            ...
                            @if(isset($detail) && $detail['types'] == 11)
