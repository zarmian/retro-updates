            ...
            <div class="col-lg-11 col-md-12 col-sm-12 col-xs-12 list-content-row">
              ...
              <div class="col-sm-12 no-padding">
                <ul class="clearfix">
                  ...
                  <li><?php echo app('translator')->getFromJson('admin/entries.voucher_number_txt'); ?>: <b> <?php echo e($sale['invoice_number']); ?> </b></li>
                  <li><?php echo app('translator')->getFromJson('admin/entries.vendor_label'); ?>: <b><?php echo e($sale['customer_name']); ?></b></li>
                  <li><?php echo app('translator')->getFromJson('admin/entries.voucher_date_label'); ?>: <b><?php echo e($sale['invoice_date']); ?></b></li>
                  <li><?php echo app('translator')->getFromJson('admin/entries.invoice_due_date_label'); ?>: <b><?php echo e($sale['due_date']); ?></b></li>
                  <li><?php echo app('translator')->getFromJson('admin/entries.tlt_txt'); ?>: <b> <?php echo e($sale['total']); ?> <?php echo e($currency); ?></b></li>
                  <li>
