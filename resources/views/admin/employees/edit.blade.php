...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      @endif
      <form id="accountForm" method="post" class="registration-form" action="{{ url('employees/update', $employee->id) }}" style="margin-top: 20px;" enctype="multipart/form-data">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
            ...
            <div class="form_container">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <input type="text" name="first_name" id="first_name" class="form-control1" placeholder="@lang('admin/employees.first_name_label')*" required="required" value="{{ $employee->first_name }}" />
              </div>
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <label for="last_name" class="input_label">&nbsp;</label>
                <input type="text"  name="last_name" id="last_name" class="form-control1" placeholder="@lang('admin/employees.last_name_label')*" required="required" value="{{ $employee->last_name }}" />
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                @if(isset($genders) && count($genders) > 0)
                  @foreach($genders as $gender)
                    <label class="btn btn-default btn-gender @if($employee->gender == $gender->id) active @endif">
                        <input type="radio" name="gender" id="gender" autocomplete="off" @if($employee->gender == $gender->id) checked="checked" @endif value="{{ $gender->id }}" /> 
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <div class="col-sm-3 col-xs-3 col-padding">
                  <input type="text" name="dob_day" id="dob_day" value="" class="datepicker form-control1 text-padding-5" required="required" data-format="d" data-fx="false" data-fx-mobile="true" placeholder="DD" data-default-date="{{ date('m-d-Y', strtotime($employee->date_of_birth)) }}"
 />
                </div>

                <div class="col-sm-3 col-xs-3 col-padding">
                  <input type="text" name="dob_month" id="dob_month" class="datepicker form-control1 text-padding-5" data-format="m" placeholder="MM" required="required" data-default-date="{{ date('m-d-Y', strtotime($employee->date_of_birth)) }}" />
                </div>

                <div class="col-sm-6 col-xs-6 col-padding">
                  <input type="text" name="dob_year" id="dob_year" class="form-control1 datepicker" data-format="Y" placeholder="YYYY" required="required" data-fx="false" data-fx-mobile="true" data-default-date="{{ date('m-d-Y', strtotime($employee->date_of_birth)) }}" />
                </div>
              </div>

              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <label for="national_id" class="input_label">@lang('admin/employees.national_id_label')</label>
                <input type="text" name="national_id" id="national_id" class="form-control1" value="{{ $employee->national_id }}"  placeholder="@lang('admin/employees.national_id_label')">
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <input type="text" name="fathers_name" id="fathers_name" class="form-control1" placeholder="@lang('admin/employees.fathers_name_label')" value="{{ $employee->fathers_name }}" />
              </div>
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <label for="mothers_name" class="input_label">@lang('admin/employees.mothers_name_label')</label>
                <input type="text" class="form-control1" name="mothers_name" id="mothers_name" placeholder="@lang('admin/employees.mothers_name_label')" value="{{ $employee->mothers_name }}"  />
              </div>



              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <label for="email" class="input_label">@lang('admin/employees.email_label')*</label>
                <input type="email" name="email" id="email" class="form-control1" value="{{ $employee->email }}" required="required" data-bv-emailaddress-message="The input is not a valid email address" placeholder="@lang('admin/employees.email_label')*" />
              </div>

              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <label for="phone" class="input_label">@lang('admin/employees.phone_label')*</label>
                <input type="text" name="phone" id="phone" value="{{ $employee->phone_no }}" required="required" class="form-control1" placeholder="@lang('admin/employees.phone_label')*">
              </div>


              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group">
                <input type="text" name="present_address" id="present_address" class="form-control1" placeholder="@lang('admin/employees.present_address_label')" value="{{ $employee->present_address }}"  />
              </div>

              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group">
                <input type="text" name="permanant_address" id="permanant_address" class="form-control1" placeholder="@lang('admin/employees.permanant_address_label')" value="{{ $employee->permanant_address }}" />
              </div>

              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group">
              <textarea name="reference" id="reference" cols="30" rows="10" class="form-control2" placeholder="@lang('admin/employees.reference_label')">{{ $employee->reference }}</textarea>
              </div>
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
            ...
            <div class="form_container">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <input type="text" name="username" id="username" class="form-control1" placeholder="@lang('admin/employees.username_label')*" value="{{ $employee->username }}" readonly="readonly" />
              </div>
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <label for="" class="input_label">&nbsp;</label>
                <input type="text"  name="employee_code" id="employee_code" class="form-control1" placeholder="@lang('admin/employees.employee_code_label')" value="{{ $employee->employee_code }}" readonly="readonly" />
              </div>

              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <input type="password" name="password" id="password" class="form-control1" placeholder="@lang('admin/employees.password_label')" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" data-bv-identical-field="password_confirmation" />
              </div>
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control1" value="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" data-bv-identical-field="password" data-bv-identical="true" placeholder="@lang('admin/employees.c_password_label')" />
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <div class="col-sm-3 col-padding">
                  <input type="text" name="joining_day" id="joining_day" class="datepicker form-control1 text-padding-5" required="required" data-format="d" data-fx="false" data-fx-mobile="true" placeholder="DD" data-default-date="{{ date('m-d-Y', strtotime($employee->joining_date)) }}" />
                </div>

                <div class="col-sm-3 col-padding ">
                  <input type="text" name="joining_month" id="joining_month" class="datepicker form-control1 text-padding-5" required="required" data-format="m" data-fx="false" data-fx-mobile="true" placeholder="MM" data-default-date="{{ date('m-d-Y', strtotime($employee->joining_date)) }}" />
                </div>

                <div class="col-sm-6 col-padding">
                  <input type="text" name="joining_year" id="joining_year"  placeholder="YYYY" class="datepicker form-control1 text-padding-5" required="required" data-format="Y" data-fx="false" data-fx-mobile="true" data-default-date="{{ date('m-d-Y', strtotime($employee->joining_date)) }}" />
                </div>
              </div>
              ...
              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group">
                ...
                <select name="status" id="status" class="form-control1" required="required">
                  <option value="1" @if($employee->status == 1) selected="selected" @endif>@lang('admin/employees.active_option')</option>
                  <option value="0" @if($employee->status == 0) selected="selected" @endif>@lang('admin/employees.inactive_option')</option>
                </select>
              </div>
                ...
                <select name="salary_type" id="salary_type" class="form-control1" required="required">
                  ...
                  @if(isset($salaries) && count($salaries) > 0)
                    @foreach($salaries as $salary)
                      @if($employee->salary_type == $salary->id)
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <input type="text" name="basic_salary" id="basic_salary" class="form-control1" value="{{ $employee->basic_salary }}" required="required" placeholder="15000.00" />
              </div>
              ...
              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding-right">
                ...
                <input type="text" name="accommodation_allowance" id="accommodation_allowance" class="form-control1" value="{{ $employee->accomodation_allowance }}" placeholder="@lang('admin/employees.accomodation')" />
              </div>

              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding">
                <label for="medical_allowance" class="input_label">&nbsp;</label>
                <input type="text" name="medical_allowance" id="medical_allowance" class="form-control1" placeholder="@lang('admin/employees.medical')" value="{{ $employee->medical_allowance }}" />
              </div>

              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding">
                <label for="transportation_allowance" class="input_label">&nbsp;</label>
                <input type="text" name="transportation_allowance" id="transportation_allowance" class="form-control1" value="{{ $employee->transportation_allowance }}" placeholder="@lang('admin/employees.transport')" />
              </div>
              ...
              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding-left">
                ...
                <input type="text" class="form-control1" name="food_allowance" id="food_allowance" value="{{ $employee->food_allowance }}" placeholder="@lang('admin/employees.food_allowance')"" />
              </div>


              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding-right">
                <label for="overtime_1" class="input_label">@lang('admin/employees.overtime')</label>
                <input type="text" name="overtime_1" id="overtime_1" class="form-control1" value="{{ $employee->overtime_1 }}" placeholder="1.25%" />
              </div>

              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding">
                <label for="" class="input_label">&nbsp;</label>
                <input type="text" name="overtime_2" id="overtime_2" class="form-control1" value="{{ $employee->overtime_2 }}" placeholder="1.50%" />
              </div>

              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding">
                <label for="" class="input_label">&nbsp;</label>
                <input type="text" name="overtime_3" id="overtime_3" class="form-control1" value="{{ $employee->overtime_3 }}" placeholder="2.50%" />
              </div>
        ...
        <fieldset>
              ...
              @foreach($qualifications as $qualification)
                ...
                <div class="eduction-container">
                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    ...
                    <input type="text" name="degree[]" id="degree" class="form-control1" value="{{$qualification->degree_name}}" placeholder="@lang('admin/employees.degree_label')" />
                  </div>
                  ...
                  <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group col-padding">
                    ...
                    <input type="text" name="year[]" id="year" class="form-control1 datepicker" data-format="Y" placeholder="YYYY" required="required" data-fx="false" data-fx-mobile="true" data-default-date="{{ date('m-d-Y', strtotime($qualification->year)) }}"  />
                  </div>
                  ...
                  <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group col-padding">
                    ...
                    <input type="text" name="total_marks[]" id="total_marks" placeholder="1100" class="form-control1" value="{{ $qualification->total_marks }}" />
                  </div>

                  <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group col-padding">
                    <label for="obtain_marks">@lang('admin/employees.obtain_marks_label')</label>
                    <input type="text" class="form-control1" name="obtain_marks[]" id="obtain_marks" class="form-control" placeholder="950" value="{{ $qualification->obtain_marks }}" />
                  </div>

                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    <label for="institute">@lang('admin/employees.institute_label')</label>
                    <input type="text" name="institute[]" id="institute" class="form-control1" placeholder="@lang('admin/employees.institute_label')" value="{{ $qualification->institute }}" />
                  </div>
                  ...
                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    ...
                    @if(isset($countries) && count($countries) > 0)
                      <option value="">@lang('admin/employees.select_option')</option>
                      @foreach($countries as $country)
                        @if($qualification->institute_country == $country->id)
                          <option value="{{ $country->id }}" selected="selected">{{ $country->country_name }}</option>
                        @else
                          <option value="{{ $country->id }}">{{ $country->country_name }}</option>
                        @endif
                  ...
                  <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group col-padding add-more-col">
                    <button type="button" class="btn btn-danger mbtn remove-more-btn btn-block">@lang('admin/employees.remove_button')</button>
                  </div>
              ...
              @if(isset($works) && count($works) > 0)
                @foreach($works as $work)
                  ...
                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    ...
                    <input type="text" name="job_title[]" id="job_title_1" class="form-control1" placeholder="@lang('admin/employees.job_title_label')" value="{{$work->job_title}}" />
                  </div>

                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    <label for="company_name_1">@lang('admin/employees.company_name_label')</label>
                    <input type="text" name="company_name[]" id="company_name_1" class="form-control1" placeholder="@lang('admin/employees.company_name_label')" value="{{$work->company_name}}" />
                  </div>
                  ...
                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    ...
                    <input type="text" name="location_city[]" id="location_city_1" class="form-control1" placeholder="@lang('admin/employees.location_city_label')" value="{{$work->city_name}}" />
                  </div>
                  ...
                  <div class="col-md-2 col-sm-2 col-lg-2 col-xs-6 form-group col-padding">
                    ...
                    <input type="text" name="start_month[]" id="start_month_1" value="" class="datepicker form-control1 text-padding-5" data-format="m" placeholder="MM" data-default-date="{{ date('m-d-Y', strtotime($work->start_date)) }}" />
                  ...
                  <div class="col-md-2 col-sm-2 col-lg-2 col-xs-6 form-group col-padding">
                    ...
                    <input type="text" name="start_year[]" id="start_year_1" class="form-control1 datepicker" data-format="Y" placeholder="YYYY" required="required" data-fx="false" data-fx-mobile="true" data-default-date="{{ date('m-d-Y', strtotime($work->start_date)) }}" />
               ...
               <input type="text" name="end_month[]" id="end_month_1" class="datepicker form-control1 text-padding-5" data-format="m" placeholder="MM" data-default-date="{{ date('m-d-Y', strtotime($work->end_date)) }}" />
                  ...
                  <div class="col-md-2 col-sm-2 col-lg-2 col-xs-6 form-group col-padding">
                    ...
                    <input type="text" name="end_year[]" id="end_year_1" class="form-control1 datepicker" data-format="Y" placeholder="YYYY" data-fx="false" data-fx-mobile="true" data-default-date="{{ date('m-d-Y', strtotime($work->end_date)) }}" />
                  ...
                  <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group col-padding add-more-col">
                    ...
                    <button type="button" class="btn btn-danger mbtn remove-more-btn-exp btn-block">@lang('admin/employees.remove_button')</button>
                  </div>
                  <div class="col-md-12"></div>
          ...
          <div class="col-sm-12 no-padding">
            <div class="col-sm-2 col-lg-2 col-md-2 col-xs-12">
            <label for="" class="input_label">&nbsp;</label>
            <button type="submit" name="submitButton" class="btn btn-primary mbtn btn-block">@lang('admin/employees.submit_button')</button>
