  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1>@lang('admin/accounting.create_coa_txt')</h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active">@lang('admin/accounting.create_coa_txt')</a>
      </div>
    </div>
  </div>
</section>
...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      <form data-toggle="validator" role="form" method="post" class="registration-form"  action="{{ url('accounting/chart/save') }}" style="margin-top: 20px;" enctype="multipart/form-data">
        ...
        <div class="form_container">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12 col-sm-offset-3 col-md-offset-3 col-sm-offset-0">
            <div class="top_content">
              <h3>@lang('admin/accounting.create_coa_txt')</h3>
            ...
            <div class="form_container">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <input type="text" name="code" id="code" class="form-control1" placeholder="@lang('admin/accounting.account_code')*" required="required" value="{{ old('code') }}" />
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <input type="text" name="opening" id="opening" class="form-control1" data-bv-integer-message="The value is not an integer" placeholder="@lang('admin/accounting.account_opening')*" value="{{ old('opening') }}" />
              </div>
