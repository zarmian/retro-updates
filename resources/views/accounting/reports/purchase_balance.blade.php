  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1>@lang('admin/reports.purchse_balance_report_txt') </h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right"><a href="{{ url('/') }}">@lang('admin/dashboard.dashboard-heading')</a>  / <a href="#" class="active">@lang('admin/reports.purchse_balance_report_txt')</a></div>
    </div>
  </div>
</section>
@endsection
...
<section class="find-search hidden-print">
  <div class="container">
    ...
    <form action="{{ url('/reports/purchase-balance') }}" method="post">
      ...
      <div class="">
        ...
        <div class="col-lg-10 no-padding">
          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 filter-input">
            <input type="text" name="voucher_no" id="voucher_no" class="filter-date-input" placeholder="@lang('admin/reports.voucher_no_txt')" value="@if(!empty($voucher_no)) {{ $voucher_no }} @endif" />
           </div>
        ...
        <div class="ac_chart">
          ...
          <table class="table table-striped">
              ...
              <div class="col-sm-3 text-center pull-right hidden-print">
                ...
                <div class="col-sm-5 no-padding-left pull-right"><a href="{{ url("/reports/purchase/export/?type=purchaseBalanceReport&customer={$customer_id}&voucher_no={$voucher_no}") }}" class="btn-default-xs btn-excel-bg btn-block"> @lang('admin/reports.export_txt') &nbsp;&nbsp; <i class="fa fa-file-excel-o" aria-hidden="true"></i></a></div>
              </div>
              ...
              @else
                <tr>
                  <td colspan="6">@lang('admin/common.notfound')</td>
                </tr>
