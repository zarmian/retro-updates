  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1>@lang('admin/vendors.create_customer_heading')</h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active">@lang('admin/vendors.create_customer_heading')</a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="col-sm-12 col-md-12 col-lg-12">
        @if(Session::has('msg'))
         ...
         <form data-toggle="validator" role="form" action="{{ url('accounting/vendors/save') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-xs-12 col-sm-offset-2">
            ...
            <div class="form_container">
                 ...
                 <div class="col-md-2 col-sm-2 col-lg-2 col-xs-2 form-group">
                  <label for="code" class="input_label">@lang('admin/vendors.code_label')</label>
                  <input type="text" name="code" id="code" class="form-control1" placeholder="@lang('admin/vendors.code_label')*" required="required" value="{{ $code }}" />
                </div>
