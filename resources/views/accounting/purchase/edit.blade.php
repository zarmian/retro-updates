  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active">@lang('admin/entries.update_purchase_heading')</a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="col-sm-12 col-md-12 col-lg-12">
        @if(Session::has('msg'))
         ...
         <form data-toggle="validator" role="form" action="{{ url('accounting/purchase/edit', $sale['id']) }}" method="POST" enctype="multipart/form-data" class="erp-form erp-ac-transaction-form">
          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-xs-12 col-sm-offset-2">
            <div class="top_content">
              <h3>@lang('admin/entries.update_purchase_heading')</h3>
            ...
            <div class="form_container">
                ...
                <div class="col-md-5 col-sm-5 col-lg-5 col-xs-5 form-group">
                  <label for="vendor" class="input_label">@lang('admin/entries.vendor_label')*</label>
                ...
                <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4 form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="invoice_no" id="invoice_no" class="form-control1" placeholder="@lang('admin/entries.voucher_number_txt')*" value="{{ $sale['invoice_number'] }}" readonly="readonly" style="border-bottom-left-radius: 0px;border-top-left-radius: 0px;" />
                  </div>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                  ...
                  <input type="text" name="invoice_date" id="invoice_date" class="form-control1 datepicker" placeholder="@lang('admin/entries.voucher_date_label')" data-default-date="{{ $sale['invoice_date']  }}" data-format="m/d/Y" data-min-year="{{ date('Y',time()) }}" data-max-year="{{ date('Y',strtotime('+10 year',time())) }}" />
                </div>
                ...
                <div class="col-sm-12">
                  <table class="erp-table erp-ac-transaction-table payment-voucher-table">
                    ...
                    @if(isset($sale['details']) )
                      @foreach($sale['details'] as $detail)
                        ...
                        <select name="title[]" id="title" class="form-control1 chosen title">
                          ...
                          {{-- <input type="text" name="title[]" id="title" class="form-control1" value="{{ $detail['title'] }}" placeholder="@lang('admin/entries.title_label')" /> --}}
                        </td>
                    ...
                    <tr class="tr">
                          ...
                          {{-- <input type="text" name="title[]" id="title" class="form-control1" placeholder="@lang('admin/entries.title_label')" /> --}}
                        </td>
