  <div class="modal-container">
    ...
    <form action="<?php echo e(url('accounting/sales/payment')); ?>" id="update" method="POST" data-toggle="validator">
    ...
    <div class="col-sm-11">
      ...
      <div class="col-sm-6 col-xs-5 col-md-6 col-lg-6 no-padding-left">
        <h4><?php echo app('translator')->getFromJson('admin/entries.customer_label'); ?>: <?php echo e($sale['customer_name']); ?> </h4>
      </div>

      <div class="col-sm-6 col-xs-5 col-md-6 col-lg-6 no-padding-right">
        <h4><?php echo app('translator')->getFromJson('admin/entries.invoice_no_txt'); ?>: <?php echo e($sale['inv_no']); ?> </h4>
      </div>

      <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 no-padding">
        <h4 class="fontsize13bold"><?php echo app('translator')->getFromJson('admin/entries.invoice_sub_total_txt'); ?>: <?php echo e($sale['sub_total']); ?> </h4>
      </div>

      <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 no-padding">
        <h4 class="fontsize13bold"><?php echo app('translator')->getFromJson('admin/entries.invoice_discount_txt'); ?>: <?php echo e($sale['discount']); ?> </h4>
      </div>

      <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 no-padding">
        <h4 class="fontsize13bold"><?php echo app('translator')->getFromJson('admin/entries.invoice_total_txt'); ?>: <?php echo e($sale['total']); ?> </h4>
      </div>
      ...
      <div class="col-sm-12 form-group">
        <label for=""></label>
        <button type="submit" id="paidInvoice" class="btn btn-primary btn-block"><?php echo app('translator')->getFromJson('admin/common.pay_button_txt'); ?></button>
      </div>
      ...
      $form.ajaxSubmit({
        ...
        success: function(responseText, statusText, xhr, $form) {
          ...
          if($.isEmptyObject(responseText.error)){
            $('div#PaymentsViews').load(site.base_url + '/accounting/sales/detail/'+ id +' div#PaymentsViews');
            $('table#total_cal').load(site.base_url + '/accounting/sales/detail/'+ id +' table#total_cal');

            $('div#paid_status').load(site.base_url + '/accounting/sales/detail/'+ id +' div#paid_status');
