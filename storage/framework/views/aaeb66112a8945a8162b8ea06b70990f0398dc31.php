  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1><?php echo app('translator')->getFromJson('admin/customers.manage_heading'); ?></h1>
      </div>
      ...
      <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/customers.manage_heading'); ?></a></div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      ...
      <form action="" method="GET">
        ...
        <input type="text" name="name" id="name" class="filter-date-input" placeholder="<?php echo app('translator')->getFromJson('admin/accounting.customer_name'); ?>" value="<?php echo e(\Request::get('name')); ?>"  />
       </div>

       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <input type="text" name="email" id="email" class="filter-date-input"  placeholder="<?php echo app('translator')->getFromJson('admin/accounting.customer_email'); ?>" value="<?php echo e(\Request::get('email')); ?>" />
       </div>
       ...
       <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 plus-margin">
        ...
        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 plus-margin"><a href="<?php echo e(url('accounting/customers/add')); ?>" class="plus">+</a></div>
    ...
    <div class="container">
      ...
      <div id="products" class="row list-group">
              ...
              <ul>
                   ...
                   <li class="">
                    ...
                    <ul>
                     ...
                     <div>
                        <a href="<?php echo e(url('accounting/customers/edit/'.$customer->id)); ?>" data-toggle="tooltip"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>

                        <a href="<?php echo e(url('accounting/customers/remove/'.$customer->id)); ?>" class="is_delete" data-toggle="tooltip"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>

                        <a href="<?php echo e(url('accounting/customers/view/'.$customer->id)); ?>" data-toggle="tooltip"><span class="fa fa-list" aria-hidden="true"></span></a>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          <div class="col-xs-12"><?php echo $customers->appends(\Input::except('page'))->render(); ?></div>
        <?php else: ?>
