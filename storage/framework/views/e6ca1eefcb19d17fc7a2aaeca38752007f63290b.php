  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1><?php echo app('translator')->getFromJson('admin/reports.purchse_balance_report_txt'); ?> </h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right"><a href="<?php echo e(url('/')); ?>"><?php echo app('translator')->getFromJson('admin/dashboard.dashboard-heading'); ?></a>  / <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/reports.purchse_balance_report_txt'); ?></a></div>
    </div>
  </div>
</section>
<?php $__env->stopSection(); ?>
...
<section class="find-search hidden-print">
  <div class="container">
    ...
    <form action="<?php echo e(url('/reports/purchase-balance')); ?>" method="post">
        ...
        <div class="col-lg-10 no-padding">
           ...
           <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 filter-dropdown">
            ...
            <select name="customer" id="customer" class="chosen form-control1">
              <option value="" disabled="disabled"><?php echo app('translator')->getFromJson('admin/reports.select_by_vendors_option_txt'); ?></option>
          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 filter-input">
            <input type="text" name="voucher_no" id="voucher_no" class="filter-date-input" placeholder="<?php echo app('translator')->getFromJson('admin/reports.voucher_no_txt'); ?>" value="<?php if(!empty($voucher_no)): ?> <?php echo e($voucher_no); ?> <?php endif; ?>" />
           </div>
        ...
        <div class="ac_chart">
          ...
          <table class="table table-striped">
              ...
              <div class="col-sm-3 text-center pull-right hidden-print">
                ...
                <div class="col-sm-5 no-padding-left pull-right"><a href="<?php echo e(url("/reports/purchase/export/?type=purchaseBalanceReport&customer={$customer_id}&voucher_no={$voucher_no}")); ?>" class="btn-default-xs btn-excel-bg btn-block"> <?php echo app('translator')->getFromJson('admin/reports.export_txt'); ?> &nbsp;&nbsp; <i class="fa fa-file-excel-o" aria-hidden="true"></i></a></div>
              </div>
              ...
              <?php else: ?>
                <tr>
                  <td colspan="6"><?php echo app('translator')->getFromJson('admin/common.notfound'); ?></td>
                </tr>
