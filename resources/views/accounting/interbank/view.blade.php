...
<section class="breadcrumb hidden-print">
  <div class="container">
    <div class="row">
      ...
      <a href="#" class="active">@lang('admin/entries.ib_heading_txt')</a>  
      </div>
    </div>
  </div>
</section>
            ...
            <div class="inv-block clearfix">
              ...
              <div class="col-sm-6 col-lg-6 col-md-6 col-xs-6 hidden-print">
                <div class="inv-no-heading">
                  <h2>@lang('admin/entries.ib_entry_code_txt'): {{ $journal['code'] }}</h2>
                </div>
              </div>
              ...
              <div class="invoice-top-space clearfix">
                ...
                <div class="text-right">
                  ...
                  <div class="invoice-detail">
                    <h4>@lang('admin/entries.ib_heading_txt')</h4>
                    <p>
                    ...
                    @if(isset($journal['details']) )
                      @foreach($journal['details'] as $detail)
                        <tr>
                          ...
                          <td class="td-dark-gray">{!! $detail['ac_name'] !!}</td>
