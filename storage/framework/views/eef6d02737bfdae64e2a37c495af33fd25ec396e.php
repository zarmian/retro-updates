  ...
  <div class="container">
    <div class="row">
      ...
      <form action="" method="GET">
        ...
        <input type="text" name="name" id="name" class="filter-date-input" placeholder="Truck Number" value="<?php echo e(\Request::get('name')); ?>"  />
       </div>
       ...
       <div class="col-lg-1 col-md-1 col-sm-2 col-xs-12 plus-margin">
        ...
        <a href="<?php echo e(url('accounting/trucks/add')); ?>" class="plus">+</a></div>
            ...
            <div class="row">
                ...
                <ul class="list-detail">
                  <li>
                    <div class="caption">
                      <ul>
                        <li class="name">Number: <b> <?php echo e($truck['name']); ?></li>
                        <li class="name">Products: </li>
                        <?php if(isset($truck['products']) ): ?>
                        <?php $__currentLoopData = $truck['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="name"><b> <?php echo e($product['name']); ?> : <b> <?php echo e($product['quantity']); ?></li>
