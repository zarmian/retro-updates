...
<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 top-margin-space-inv">
            ...
            <div class="inv-block clearfix">
            	...
            	<table width="100%">
                    ...
                    <h1 style="font-size: 18px;">@lang('admin/entries.invoice_no_txt'): {{ $sale['inv_no'] }}</h1>
                  ...
                  <div class="invoice-detail">
                    ...
                    <p>
                      @lang('admin/entries.invoice_date_label'): {{ $sale['inv_date']}} <br>
              ...
              <div class="invoice-top-space clearfix">
                    ...
                    @if(isset($sale['details']) )
                      @foreach($sale['details'] as $detail)
                        <tr>
                          ...
                          <td class="td-dark-gray text-center" style="background: #efefef !important"><b>{{ $detail['unit_price'] }}</b></td>
                          <td class="td-light-gray text-center" style="background: #f5f5f5 !important;"><b>{{ $detail['amount'] }}</b></td>
                        </tr>
                      @endforeach
                    @endif
                ...
                <div class="">
                 <table class="table table-bordered total_cal" width="300" style="width: 300px !important" id="total_cal" align="right">
                   <tr>
                     <td width="150" height="30" class="text-right" style="padding-right: 20px;">@lang('admin/entries.sub_total_txt')</td>
                     <td style="padding-left: 20px;">{{ $sale['unit_price'] }}</td>
                   </tr>

                   <tr>
                     <td style="padding-right: 20px;" height="30" class="text-right">@lang('admin/entries.discount_txt')</td>
                     <td style="padding-left: 20px;">{{ $sale['discount'] }}</td>
                   </tr>

                   <tr>
                     <td style="padding-right: 20px;" height="30" class="text-right">@lang('admin/entries.total_txt')</td>
                     <td style="padding-left: 20px;">{{ $sale['total'] }}</td>
                   </tr>

                   <tr>
                     <td style="padding-right: 20px;" height="30" class="text-right">@lang('admin/entries.total_paid_txt')</td>
                     <td style="padding-left: 20px;">{{ $sale['tlt_paid_sum'] }}</td>
                   </tr>

                   <tr>
                     <td style="padding-right: 20px;" height="30" class="text-right">@lang('admin/entries.amount_due_txt')</td>
                     <td style="padding-left: 20px;">{{ $sale['due_amount'] }}</td>
                   </tr>
                 </table>
               </div>
              </div>
