  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1>@lang('admin/users.create_group')</h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active">@lang('admin/users.create_group')</a>
      </div>
    </div>
  </div>
</section>
...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      @endif
      <form id="group_form" method="post" class="registration-form" action="{{ route('admin.manage-groups.store') }}" style="margin-top: 20px;" enctype="multipart/form-data">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
            ...
            <div class="form_container">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding">
                ...
                <input type="text" name="name" id="name" class="form-control1" placeholder="@lang('admin/users.role_title_label')*" required="required" value="" />
              </div>
            ...
            <div class="form_container">
              ...
              @if(isset($permissions) )
                  ...
                  @if(isset($allowed_permissions[$permission->name]) && $allowed_permissions[$permission->name] == 'true')
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xs-12 permission_margin">
