  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/entries.update_sales_heading'); ?></a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="col-sm-12 col-md-12 col-lg-12">
        <?php if(Session::has('msg')): ?>
         ...
         <form data-toggle="validator" role="form" action="<?php echo e(url('accounting/sales/edit', $sale['id'])); ?>" method="POST" enctype="multipart/form-data" class="erp-form erp-ac-transaction-form">
          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-xs-12 col-sm-offset-2">
            <div class="top_content">
              <h3><?php echo app('translator')->getFromJson('admin/entries.update_sales_heading'); ?></h3>
            ...
            <div class="form_container">
                ...
                <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4 form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="invoice_no" id="invoice_no" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/entries.invoice_no_label'); ?>*" value="<?php echo e($sale['invoice_number']); ?>" readonly="readonly"  style="border-bottom-left-radius: 0px;border-top-left-radius: 0px;" />
                  </div>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                  ...
                  <input type="text" name="invoice_date" id="invoice_date" class="form-control1 datepicker" placeholder="<?php echo app('translator')->getFromJson('admin/entries.invoice_date_label'); ?>" data-default-date="<?php echo e($sale['invoice_date']); ?>" data-format="m/d/Y" data-min-year="<?php echo e(date('Y',time())); ?>" data-max-year="<?php echo e(date('Y',strtotime('+10 year',time()))); ?>" />
                </div>
                            ...
                            <th class="col-amount">
                                ...
                                <?php if(isset($tax) && count($tax) > 0): ?>
                                  <?php $__currentLoopData = $tax; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($sale['vat_tax_id'] == $tax->id): ?>
                                      <option value="<?php echo e($tax->id); ?>" selected="selected"><?php echo e($tax->name); ?></option>
                                    <?php else: ?>
