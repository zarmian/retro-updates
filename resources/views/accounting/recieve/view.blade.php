...
<section class="breadcrumb hidden-print">
  <div class="container">
    <div class="row">
      ...
      <a href="{{ url('accounting/payments/received') }}">Payment Recieved Voucher</a> / 
      <a href="#" class="active">View Recieved Voucher</a>  
      </div>
    </div>
  </div>
</section>
              ...
              <div class="invoice-top-space clearfix">
                ...
                <div class="text-right">
                  ...
                  <div class="invoice-detail">
                    <h4>Payment Recieved Voucher</h4>
                    <p>
