  ...
  <div class="container">
    <div class="row">
      ...
      <form action="" method="GET">
        ...
        <input type="text" name="destination" id="destination" class="filter-date-input" placeholder="Destination" value="{{ \Request::get('destination') }}"  />
       </div>
       ...
       <div class="col-lg-1 col-md-1 col-sm-2 col-xs-12 plus-margin">
        ...
        <a href="{{ url('accounting/destination/add') }}" class="plus">+</a></div>
            ...
            <div class="row">
                ...
                <ul class="list-detail">
                  <li>
                    <div class="caption">
                      <ul>
                        <li class="name">Destination: <b> {{ $item['destination'] }}</li>
                      </ul>
                    </div>
                  </li>
                </ul>
...
{{--                  <li><a href="{{ url('accounting/items/edit/'.$item['id']) }}" data-toggle="tooltip" title="Edit"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a></li>--}}
                  <li><a href="{{ url('accounting/destination/delete/'.$item['id']) }}" data-toggle="tooltip" title="Delete" class="is_delete"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></li>
                </ul>
