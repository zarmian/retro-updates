...
<section class="breadcrumb hidden-print">
  <div class="container">
    <div class="row">
      ...
      <a href="#" class="active">@lang('admin/entries.manage_payment_txt')</a>  
      </div>
    </div>
  </div>
</section>
            ...
            <div class="inv-block clearfix">
              ...
              <div class="col-sm-6 col-lg-6 col-md-6 col-xs-6 hidden-print">
                <div class="inv-no-heading">
                  <h2>@lang('admin/entries.invoice_no_txt'): @lang('admin/common.inv_prefix') {{ $sale['inv_no'] }}</h2>
                </div>
              </div>
                    ...
                    <li><a href="javascript:void(0)" id="do-email"></a>
                      ...
                      <li role="presentation" class="dropdown btn-env"> <a class="payment-btn btn-pink-bg" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-envelope"></i> </a>
                        ...
                        <ul class="dropdown-menu invoice-menu">
                          <li><a href="javascript:void(0)" id="mail_invoice_created" data-id="{{ $sale['id']}}" data-st="created">@lang('admin/entries.create_invoice_btn')</a></li>
                          <li> <a href="javascript:void(0)" id="mail_invoice_reminder" data-id="{{ $sale['id']}}" data-st="reminder">@lang('admin/entries.create_payment_reminder_btn')</a></li>
                          <li><a href="javascript:void(0)" id="mail_invoice_overdue" data-id="{{ $sale['id']}}" data-st="overdue">@lang('admin/entries.create_invoice_overdue_btn')</a></li>
                          <li><a href="javascript:void(0)" id="mail_invoice_confirm" data-id="{{ $sale['id']}}" data-st="confirmation">@lang('admin/entries.invoice_payement_confirmation')</a></li>
              ...
              <div class="invoice-top-space clearfix">
                <div class="col-sm-12 col-lg-12 col-xs-12 col-md-12">
                  <div class="col-sm-7 col-lg-7 col-md-7 col-xs-12 invoice-left-block">
                    ...
                    <h2 class="visible-print-block">@lang('admin/entries.invoice_no_txt'): {{ $sale['inv_no'] }}</h2>
                ...
                <div class="text-right">
                  ...
                  <div class="invoice-detail">
                    <h4>@lang('admin/entries.invoice_detail_txt')</h4>
                    <p>
                      <b>@lang('admin/entries.invoice_date_label'): {{ $sale['inv_date']}}</b> <br>
                  ...
                  <div class="customer-detail">
                    <h3>@lang('admin/entries.invoice_customer_detail_txt')</h3>
            ...
            <div class="inv-block clearfix">
              ...
              <div class="col-sm-12 col-lg-12 col-xs-12 col-md-12">
                ...
                <div class="invoice-payments no-print">
                  ...
                  <div class="amounts">
                    <p>
                      @lang('admin/entries.invoice_total_txt'): {{ $sale['total'] }} <br>
                      @lang('admin/entries.total_paid_txt'): {{ $sale['tlt_paid_sum'] }} <br>
                  ...
                  @if(isset($sale['payments']) )
                    @foreach($sale['payments'] as $payment)
                      ...
                      <div class="payment-detail">
                        <p>
                          @lang('admin/entries.paid_amount_txt'): {{ $payment['amount'] }} <br>
                          @lang('admin/entries.account_label'): {{ $payment['account_name'] }} <br>
