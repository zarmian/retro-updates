  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/shift.create-heading'); ?></a>
      </div>
    </div>
  </div>
</section>
...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      <form data-toggle="validator" role="form" method="post" class="registration-form"  action="<?php echo e(url('/shift/store')); ?>" style="margin-top: 20px;" enctype="multipart/form-data">
          ...
          <div class="col-sm-12 col-md-7 col-lg-7 col-xs-12 col-sm-offset-2 col-md-offset-2 col-sm-offset-0">
            ...
            <div class="form_container">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding-left">
                ...
                <input type="text" name="title" id="title" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/shift.title'); ?>*" required="required" value="" />
              </div>

              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding">
                <label for="name" class="input_label"><?php echo app('translator')->getFromJson('admin/shift.status_label'); ?></label>
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding-left">
                ...
                <input type="text" name="start_time" id="start_time" class="form-control1 timepicker" placeholder="<?php echo app('translator')->getFromJson('admin/shift.start_time'); ?>*" required="required" value="<?php echo e(date('h:i A', time())); ?> " />
              </div>

              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding">
                <label for="end_time" class="input_label"><?php echo app('translator')->getFromJson('admin/shift.end_time'); ?></label>
                <input type="text" name="end_time" id="end_time" class="form-control1 timepicker" placeholder="<?php echo app('translator')->getFromJson('admin/shift.end_time'); ?>*" required="required" value="<?php echo e(date('h:i A', time() + 28800)); ?>" />
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group no-padding">
                ...
                <textarea name="description" id="description" cols="30" rows="10" class="form-control2" placeholder="<?php echo app('translator')->getFromJson('admin/shift.description_label'); ?>"><?php echo e(old('description')); ?></textarea>
              </div>
