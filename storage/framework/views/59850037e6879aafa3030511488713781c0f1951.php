  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1><?php echo app('translator')->getFromJson('admin/employees.update'); ?></h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/employees.update'); ?></a>
      </div>
    </div>
  </div>
</section>
...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      <?php endif; ?>
      <form id="accountForm" method="post" class="registration-form" action="<?php echo e(url('employees/update', $employee->id)); ?>" style="margin-top: 20px;" enctype="multipart/form-data">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
            ...
            <div class="form_container">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <input type="text" name="first_name" id="first_name" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.first_name_label'); ?>*" required="required" value="<?php echo e($employee->first_name); ?>" />
              </div>
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <label for="last_name" class="input_label">&nbsp;</label>
                <input type="text"  name="last_name" id="last_name" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.last_name_label'); ?>*" required="required" value="<?php echo e($employee->last_name); ?>" />
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <?php if(isset($genders) && count($genders) > 0): ?>
                  <?php $__currentLoopData = $genders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="btn btn-default btn-gender <?php if($employee->gender == $gender->id): ?> active <?php endif; ?>">
                        <input type="radio" name="gender" id="gender" autocomplete="off" <?php if($employee->gender == $gender->id): ?> checked="checked" <?php endif; ?> value="<?php echo e($gender->id); ?>" /> 
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <div class="col-sm-3 col-xs-3 col-padding">
                  <input type="text" name="dob_day" id="dob_day" value="" class="datepicker form-control1 text-padding-5" required="required" data-format="d" data-fx="false" data-fx-mobile="true" placeholder="DD" data-default-date="<?php echo e(date('m-d-Y', strtotime($employee->date_of_birth))); ?>"
 />
                </div>

                <div class="col-sm-3 col-xs-3 col-padding">
                  <input type="text" name="dob_month" id="dob_month" class="datepicker form-control1 text-padding-5" data-format="m" placeholder="MM" required="required" data-default-date="<?php echo e(date('m-d-Y', strtotime($employee->date_of_birth))); ?>" />
                </div>

                <div class="col-sm-6 col-xs-6 col-padding">
                  <input type="text" name="dob_year" id="dob_year" class="form-control1 datepicker" data-format="Y" placeholder="YYYY" required="required" data-fx="false" data-fx-mobile="true" data-default-date="<?php echo e(date('m-d-Y', strtotime($employee->date_of_birth))); ?>" />
                </div>
              </div>

              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <label for="national_id" class="input_label"><?php echo app('translator')->getFromJson('admin/employees.national_id_label'); ?></label>
                <input type="text" name="national_id" id="national_id" class="form-control1" value="<?php echo e($employee->national_id); ?>"  placeholder="<?php echo app('translator')->getFromJson('admin/employees.national_id_label'); ?>">
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <?php if(isset($countries) && count($countries) > 0): ?>
                  <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($employee->nationality == $country->id): ?>
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <input type="text" name="fathers_name" id="fathers_name" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.fathers_name_label'); ?>" value="<?php echo e($employee->fathers_name); ?>" />
              </div>
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <label for="mothers_name" class="input_label"><?php echo app('translator')->getFromJson('admin/employees.mothers_name_label'); ?></label>
                <input type="text" class="form-control1" name="mothers_name" id="mothers_name" placeholder="<?php echo app('translator')->getFromJson('admin/employees.mothers_name_label'); ?>" value="<?php echo e($employee->mothers_name); ?>"  />
              </div>



              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <label for="email" class="input_label"><?php echo app('translator')->getFromJson('admin/employees.email_label'); ?>*</label>
                <input type="email" name="email" id="email" class="form-control1" value="<?php echo e($employee->email); ?>" required="required" data-bv-emailaddress-message="The input is not a valid email address" placeholder="<?php echo app('translator')->getFromJson('admin/employees.email_label'); ?>*" />
              </div>

              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <label for="phone" class="input_label"><?php echo app('translator')->getFromJson('admin/employees.phone_label'); ?>*</label>
                <input type="text" name="phone" id="phone" value="<?php echo e($employee->phone_no); ?>" required="required" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.phone_label'); ?>*">
              </div>


              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group">
                <input type="text" name="present_address" id="present_address" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.present_address_label'); ?>" value="<?php echo e($employee->present_address); ?>"  />
              </div>

              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group">
                <input type="text" name="permanant_address" id="permanant_address" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.permanant_address_label'); ?>" value="<?php echo e($employee->permanant_address); ?>" />
              </div>

              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group">
              <textarea name="reference" id="reference" cols="30" rows="10" class="form-control2" placeholder="<?php echo app('translator')->getFromJson('admin/employees.reference_label'); ?>"><?php echo e($employee->reference); ?></textarea>
              </div>
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
            ...
            <div class="form_container">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <input type="text" name="username" id="username" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.username_label'); ?>*" value="<?php echo e($employee->username); ?>" readonly="readonly" />
              </div>
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <label for="" class="input_label">&nbsp;</label>
                <input type="text"  name="employee_code" id="employee_code" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.employee_code_label'); ?>" value="<?php echo e($employee->employee_code); ?>" readonly="readonly" />
              </div>

              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <input type="password" name="password" id="password" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.password_label'); ?>" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" data-bv-identical-field="password_confirmation" />
              </div>
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control1" value="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" data-bv-identical-field="password" data-bv-identical="true" placeholder="<?php echo app('translator')->getFromJson('admin/employees.c_password_label'); ?>" />
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <div class="col-sm-3 col-padding">
                  <input type="text" name="joining_day" id="joining_day" class="datepicker form-control1 text-padding-5" required="required" data-format="d" data-fx="false" data-fx-mobile="true" placeholder="DD" data-default-date="<?php echo e(date('m-d-Y', strtotime($employee->joining_date))); ?>" />
                </div>

                <div class="col-sm-3 col-padding ">
                  <input type="text" name="joining_month" id="joining_month" class="datepicker form-control1 text-padding-5" required="required" data-format="m" data-fx="false" data-fx-mobile="true" placeholder="MM" data-default-date="<?php echo e(date('m-d-Y', strtotime($employee->joining_date))); ?>" />
                </div>

                <div class="col-sm-6 col-padding">
                  <input type="text" name="joining_year" id="joining_year"  placeholder="YYYY" class="datepicker form-control1 text-padding-5" required="required" data-format="Y" data-fx="false" data-fx-mobile="true" data-default-date="<?php echo e(date('m-d-Y', strtotime($employee->joining_date))); ?>" />
                </div>
              </div>
              ...
              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group">
                ...
                <select name="status" id="status" class="form-control1" required="required">
                  <option value="1" <?php if($employee->status == 1): ?> selected="selected" <?php endif; ?>><?php echo app('translator')->getFromJson('admin/employees.active_option'); ?></option>
                  <option value="0" <?php if($employee->status == 0): ?> selected="selected" <?php endif; ?>><?php echo app('translator')->getFromJson('admin/employees.inactive_option'); ?></option>
                </select>
              </div>
              ...
              <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4 form-group">
                ...
                <?php if(isset($shifts) && count($shifts) > 0): ?>
                  <?php $__currentLoopData = $shifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($shift->id == $employee->shift_id): ?>
              ...
              <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4 form-group">
                ...
                <?php if(isset($types) && count($types) > 0): ?>
                  <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($type->id == $employee->employee_type): ?>
              ...
              <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4 form-group">
                ...
                <?php if(isset($types) && count($types) > 0): ?>
                  <?php for($i=1; $i<=10; $i++): ?>
                    <?php if($employee->allowed_leaves == $i): ?>
                ...
                <select name="salary_type" id="salary_type" class="form-control1" required="required">
                  ...
                  <?php if(isset($salaries) && count($salaries) > 0): ?>
                    <?php $__currentLoopData = $salaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if($employee->salary_type == $salary->id): ?>
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                ...
                <input type="text" name="basic_salary" id="basic_salary" class="form-control1" value="<?php echo e($employee->basic_salary); ?>" required="required" placeholder="15000.00" />
              </div>
              ...
              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding-right">
                ...
                <input type="text" name="accommodation_allowance" id="accommodation_allowance" class="form-control1" value="<?php echo e($employee->accomodation_allowance); ?>" placeholder="<?php echo app('translator')->getFromJson('admin/employees.accomodation'); ?>" />
              </div>

              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding">
                <label for="medical_allowance" class="input_label">&nbsp;</label>
                <input type="text" name="medical_allowance" id="medical_allowance" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.medical'); ?>" value="<?php echo e($employee->medical_allowance); ?>" />
              </div>

              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding">
                <label for="transportation_allowance" class="input_label">&nbsp;</label>
                <input type="text" name="transportation_allowance" id="transportation_allowance" class="form-control1" value="<?php echo e($employee->transportation_allowance); ?>" placeholder="<?php echo app('translator')->getFromJson('admin/employees.transport'); ?>" />
              </div>
              ...
              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding-left">
                ...
                <input type="text" class="form-control1" name="food_allowance" id="food_allowance" value="<?php echo e($employee->food_allowance); ?>" placeholder="<?php echo app('translator')->getFromJson('admin/employees.food_allowance'); ?>"" />
              </div>


              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding-right">
                <label for="overtime_1" class="input_label"><?php echo app('translator')->getFromJson('admin/employees.overtime'); ?></label>
                <input type="text" name="overtime_1" id="overtime_1" class="form-control1" value="<?php echo e($employee->overtime_1); ?>" placeholder="1.25%" />
              </div>

              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding">
                <label for="" class="input_label">&nbsp;</label>
                <input type="text" name="overtime_2" id="overtime_2" class="form-control1" value="<?php echo e($employee->overtime_2); ?>" placeholder="1.50%" />
              </div>

              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group col-padding">
                <label for="" class="input_label">&nbsp;</label>
                <input type="text" name="overtime_3" id="overtime_3" class="form-control1" value="<?php echo e($employee->overtime_3); ?>" placeholder="2.50%" />
              </div>
        ...
        <fieldset>
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
              ...
              <?php $__currentLoopData = $qualifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qualification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="eduction-container">
                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    ...
                    <input type="text" name="degree[]" id="degree" class="form-control1" value="<?php echo e($qualification->degree_name); ?>" placeholder="<?php echo app('translator')->getFromJson('admin/employees.degree_label'); ?>" />
                  </div>
                  ...
                  <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group col-padding">
                    ...
                    <input type="text" name="year[]" id="year" class="form-control1 datepicker" data-format="Y" placeholder="YYYY" required="required" data-fx="false" data-fx-mobile="true" data-default-date="<?php echo e(date('m-d-Y', strtotime($qualification->year))); ?>"  />
                  </div>
                  ...
                  <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group col-padding">
                    ...
                    <input type="text" name="total_marks[]" id="total_marks" placeholder="1100" class="form-control1" value="<?php echo e($qualification->total_marks); ?>" />
                  </div>

                  <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group col-padding">
                    <label for="obtain_marks"><?php echo app('translator')->getFromJson('admin/employees.obtain_marks_label'); ?></label>
                    <input type="text" class="form-control1" name="obtain_marks[]" id="obtain_marks" class="form-control" placeholder="950" value="<?php echo e($qualification->obtain_marks); ?>" />
                  </div>

                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    <label for="institute"><?php echo app('translator')->getFromJson('admin/employees.institute_label'); ?></label>
                    <input type="text" name="institute[]" id="institute" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.institute_label'); ?>" value="<?php echo e($qualification->institute); ?>" />
                  </div>

                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    <label for=""><?php echo app('translator')->getFromJson('admin/employees.institute_country_label'); ?></label>
                    <select name="institute_country[]" id="institute_country" class="form-control1">
                    <?php if(isset($countries) && count($countries) > 0): ?>
                      <option value=""><?php echo app('translator')->getFromJson('admin/employees.select_option'); ?></option>
                      <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($qualification->institute_country == $country->id): ?>
                          <option value="<?php echo e($country->id); ?>" selected="selected"><?php echo e($country->country_name); ?></option>
                        <?php else: ?>
                          <option value="<?php echo e($country->id); ?>"><?php echo e($country->country_name); ?></option>
                        <?php endif; ?>
                  ...
                  <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group col-padding add-more-col">
                    <button type="button" class="btn btn-danger mbtn remove-more-btn btn-block"><?php echo app('translator')->getFromJson('admin/employees.remove_button'); ?></button>
                  </div>
            ...
            <?php endif; ?>
              ...
              <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group col-padding">
                <label for="year"><?php echo app('translator')->getFromJson('admin/employees.year_label'); ?></label>
                <input type="text" name="year[]" id="year" class="form-control1 datepicker" data-format="Y" placeholder="YYYY" required="required" data-fx="false" data-fx-mobile="true"  />
              </div>
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
            ...
            <div class="form_container">
              ...
              <?php if(isset($works) && count($works) > 0): ?>
                <?php $__currentLoopData = $works; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $work): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    ...
                    <input type="text" name="job_title[]" id="job_title_1" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.job_title_label'); ?>" value="<?php echo e($work->job_title); ?>" />
                  </div>

                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    <label for="company_name_1"><?php echo app('translator')->getFromJson('admin/employees.company_name_label'); ?></label>
                    <input type="text" name="company_name[]" id="company_name_1" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.company_name_label'); ?>" value="<?php echo e($work->company_name); ?>" />
                  </div>


                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    <label for="location_country_1"><?php echo app('translator')->getFromJson('admin/employees.location_country_label'); ?></label>
                    <select name="location_country[]" id="location_country_1" class="form-control1">
                    <?php if(isset($countries) && count($countries) > 0): ?>
                      <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($work->country_id == $country->id): ?>
                          <option value="<?php echo e($country->id); ?>" selected="selected"><?php echo e($country->country_name); ?></option>
                        <?php else: ?>
                          <option value="<?php echo e($country->id); ?>"><?php echo e($country->country_name); ?></option>
                        <?php endif; ?>
                  ...
                  <div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">
                    ...
                    <input type="text" name="location_city[]" id="location_city_1" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/employees.location_city_label'); ?>" value="<?php echo e($work->city_name); ?>" />
                  </div>
                  ...
                  <div class="col-md-2 col-sm-2 col-lg-2 col-xs-6 form-group col-padding">
                    ...
                    <input type="text" name="start_month[]" id="start_month_1" value="" class="datepicker form-control1 text-padding-5" data-format="m" placeholder="MM" data-default-date="<?php echo e(date('m-d-Y', strtotime($work->start_date))); ?>" />
                  ...
                  <div class="col-md-2 col-sm-2 col-lg-2 col-xs-6 form-group col-padding">
                    ...
                    <input type="text" name="start_year[]" id="start_year_1" class="form-control1 datepicker" data-format="Y" placeholder="YYYY" required="required" data-fx="false" data-fx-mobile="true" data-default-date="<?php echo e(date('m-d-Y', strtotime($work->start_date))); ?>" />
               ...
               <input type="text" name="end_month[]" id="end_month_1" class="datepicker form-control1 text-padding-5" data-format="m" placeholder="MM" data-default-date="<?php echo e(date('m-d-Y', strtotime($work->end_date))); ?>" />
                  ...
                  <div class="col-md-2 col-sm-2 col-lg-2 col-xs-6 form-group col-padding">
                    ...
                    <input type="text" name="end_year[]" id="end_year_1" class="form-control1 datepicker" data-format="Y" placeholder="YYYY" data-fx="false" data-fx-mobile="true" data-default-date="<?php echo e(date('m-d-Y', strtotime($work->end_date))); ?>" />
                  ...
                  <div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group col-padding add-more-col">
                    ...
                    <button type="button" class="btn btn-danger mbtn remove-more-btn-exp btn-block"><?php echo app('translator')->getFromJson('admin/employees.remove_button'); ?></button>
                  </div>
                  <div class="col-md-12"></div>
              ...
              <div class="col-md-2 col-sm-2 col-lg-2 col-xs-6 form-group col-padding">
                <label for="end_month_1"><?php echo app('translator')->getFromJson('admin/employees.to_date_label'); ?></label>
               <input type="text" name="end_month[]" id="end_month_1" value="" class="datepicker form-control1 text-padding-5" data-format="m" placeholder="MM"  data-init-set="false" />
              </div>
          ...
          <div class="col-sm-12 no-padding">
            <div class="col-sm-2 col-lg-2 col-md-2 col-xs-12">
            <label for="" class="input_label">&nbsp;</label>
            <button type="submit" name="submitButton" class="btn btn-primary mbtn btn-block"><?php echo app('translator')->getFromJson('admin/employees.submit_button'); ?></button>
    ...
    $(document).on('click', '.add-more-btn', function (){
      ...
      btn.closest('.add-more-col').find('button').html('REMOVE').attr('data-id', 'remove').removeClass('btn-primary add-more-btn').addClass('btn-danger remove-more-btn');
        ...
        html += '<div class="col-md-3 col-sm-3 col-lg-3 col-xs-12 form-group col-padding">';
          ...
          html += '<input type="text" name="year[]" id="year" class="form-control1 datepicker" data-format="Y" placeholder="YYYY" required="required" data-fx="false" data-fx-mobile="true"  />';
        html += '</div>';
        ...
        html += '<div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">';
          ...
          html += '<select name="institute_country[]" id="institute_country" class="form-control1">'+institute_country+'</select>';
        html += '</div>';
      ...
      btn.closest('.add-more-col').find('button').html('REMOVE').attr('data-id', 'remove').removeClass('btn-primary add-more-btn-exp').addClass('btn-danger remove-more-btn-exp');
        ...
        html += '<div class="experience-container">';
          ...
          html += '<div class="col-md-6 col-sm-6 col-lg-6 col-xs-12 form-group col-padding">';
            ...
            html += '<select name="location_country[]" id="location_country_1" class="form-control1">';
            <?php if(isset($countries) && count($countries) > 0): ?>
          ...
          html += '<div class="col-md-2 col-sm-2 col-lg-2 col-xs-4 form-group col-padding">';
            ...
            html += '<input type="text" name="start_year[]" id="start_year_1" class="form-control1 datepicker" data-format="Y" placeholder="YYYY" required="required" data-fx="false" data-fx-mobile="true" />';
