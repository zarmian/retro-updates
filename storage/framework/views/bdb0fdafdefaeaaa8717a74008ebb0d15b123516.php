  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1><?php echo app('translator')->getFromJson('admin/vendors.customer_detail_heading'); ?></h1>
      </div>
            ...
            <div class="ibox-title">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th width="140"> <?php echo app('translator')->getFromJson('admin/entries.amt_txt'); ?></th>
                    ...
                    <tbody>
                      <?php $__currentLoopData = $recents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            <td><a href="<?php echo e(url('accounting/purchase/detail', $recent['id'])); ?>"> <?php echo e($recent['invoice_number']); ?> </a> </td>
