  ...
  <div class="container">
    <div class="row">
      ...
      <form action="" method="GET">
        ...
        <input type="text" name="origin" id="origin" class="filter-date-input" placeholder="Origin" value="<?php echo e(\Request::get('origin')); ?>"  />
       </div>
       ...
       <div class="col-lg-1 col-md-1 col-sm-2 col-xs-12 plus-margin">
        ...
        <a href="<?php echo e(url('accounting/origin/add')); ?>" class="plus">+</a></div>
            ...
            <div class="row">
                ...
                <ul class="list-detail">
                  <li>
                    <div class="caption">
                      <ul>
                        <li class="name">Origin: <b> <?php echo e($origin['origin']); ?></li>
                      </ul>
                    </div>
                  </li>
                </ul>
                <ul class="inner-btn clearfix">
                  ...
                  <li><a href="<?php echo e(url('accounting/origin/delete/'.$origin['id'])); ?>" data-toggle="tooltip" title="Delete" class="is_delete"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></li>
                </ul>
