...
class PaymentsSendController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            $journals = $qry->where('type', '9')->orderBy('code', 'DESC')->paginate($data['per_page']);
            ...
            return view('accounting/send/index', $data);
    ...
    public function create()
    {
        ...
        try {
            ...
            return view('accounting/send/create', ['accounts' => $expense_data, 'code' => $code, 'banks' => $bank_accounts]);
    ...
    public function store(Request $request)
    {
        try {
            ...
            $rules = [
                'date' => 'required',
                'code' => 'required|unique:tbl_accounts_summery,code,null,null,type,9',
            ];
            ...
            if($id){
                ...
                return redirect('accounting/payments/send/add');

            }
            

        } catch (ModelNotFoundException $e) {
            return redirect('accounting/payments/send');
        }
    }
    ...
    public function edit($id = NULL)
    {
        try {
            ...
            if(is_null($id)) return redirect('accounting/payments/send');
            ...
            return view('accounting/send/edit', ['accounts' => $expense_data, 'journal' => $data['journal'], 'banks' => $bank_accounts]);
    ...
    public function show($id = NULL)
    {
        try {
            ...
            return view('accounting/send/view', $data);
    ...
    public function update(Request $request, $id = NULL)
    {
        try {
            ...
            $request->session()->flash('msg', 'Send Payment Voucher updated sucssfully.');
            return redirect('accounting/payments/send/edit/'.$id);
