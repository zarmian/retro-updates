...
<section class="breadcrumb hidden-print">
  <div class="container">
    <div class="row">
      ...
      <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/entries.view_purchase_heading'); ?></a>  
      </div>
    </div>
  </div>
</section>
            ...
            <div class="inv-block clearfix">
              ...
              <div class="col-sm-6 col-lg-6 col-md-6 col-xs-6 hidden-print">
                <div class="inv-no-heading">
                  <h2><?php echo app('translator')->getFromJson('admin/entries.voucher_number_txt'); ?>: <?php echo app('translator')->getFromJson('admin/common.vr_prefix'); ?><?php echo e($sale['inv_no']); ?></h2>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-lg-6 col-md-6 col-xs-6 no-padding-right">
                <div class="invoice_btns text-right">
                  <ul class="hidden-print">
                    ...
                    <li><a href="<?php echo e(url('accounting/purchase/edit', $sale['id'])); ?>" class="payment-btn btn-light-purple-bg"><i class="fa fa-eye"></i></a></li>
                    <li><a data-toggle="modal" data-target="#VoucherpaymentModal" data-id="<?php echo e($sale['id']); ?>" rel="tooltip" class="payment-btn btn-gray-bg cursor-pointer"><i class="fa fa-plus"></i></a></li>
                    ...
                    <li><a href="javascript:void(0)" id="do-email"></a>
                      ...
                      <li role="presentation" class="dropdown btn-env"> <a class="payment-btn btn-pink-bg" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-envelope"></i> </a>
                        ...
                        <ul class="dropdown-menu invoice-menu">
                          <li><a href="javascript:void(0)" id="mail_voucher_created" data-id="<?php echo e($sale['id']); ?>" data-st="created"><?php echo app('translator')->getFromJson('admin/entries.create_voucher_btn'); ?></a></li>
              ...
              <div class="invoice-top-space clearfix">
                ...
                <div class="text-right">
                  ...
                  <div class="invoice-detail">
                    ...
                    <p>
                      <b><?php echo app('translator')->getFromJson('admin/entries.voucher_date_label'); ?>: <?php echo e($sale['inv_date']); ?></b> <br>
                ...
                <div class="col-sm-5 col-sm-offset-7">
                 <table class="table table-bordered total_cal" id="total_cal">
                   <tr>
                     ...
                     <td><?php echo e(number_format($sale['details2']->sum('unit_price'), 2)); ?> <?php echo e($currency); ?></td>
                   </tr>

                   <tr>
                     <th class="text-right"><?php echo app('translator')->getFromJson('admin/entries.discount_txt'); ?></th>
                     <td><?php echo e(number_format($sale['discount'], 2)); ?> <?php echo e($currency); ?></td>
                   </tr>

                   <tr>
                     <th class="text-right"><?php echo app('translator')->getFromJson('admin/entries.invoice_total_txt'); ?></th>
                     <td><?php echo e(number_format($sale['details2']->sum('amount') - $sale['discount'], 2)); ?> <?php echo e($currency); ?></td>
                   </tr>

                   <tr>
                     <th class="text-right"><?php echo app('translator')->getFromJson('admin/entries.total_amount_txt'); ?></th>
                     <td><?php echo e(number_format($sale['payments']->sum('amount'), 2)); ?> <?php echo e($currency); ?></td>
                   </tr>

                   <tr>
                     <th class="text-right"><?php echo app('translator')->getFromJson('admin/entries.amount_due_txt'); ?></th>
                     <td><?php echo e(number_format($sale['details2']->sum('amount') - $sale['discount'] - $sale['payments']->sum('amount'), 2)); ?> <?php echo e($currency); ?></td>
                   </tr>
                 </table>
               </div>
                    ...
                    <tr>
                      ...
                      <?php $__currentLoopData = $sale['payments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td class="td-light-gray text-center" height="30" style="background: #f5f5f5 !important"><b><?php echo e(number_format($payment->amount, 2)); ?> <?php echo e($currency); ?></b></td>
            ...
            <div class="inv-block clearfix">
              ...
              <div class="col-sm-12 col-lg-12 col-xs-12 col-md-12">
                ...
                <div class="invoice-payments no-print">
                  ...
                  <div class="amounts">
                    <p>
                      <?php echo app('translator')->getFromJson('admin/entries.invoice_total_txt'); ?>:  <?php echo e(number_format($sale['details2']->sum('amount') - $sale['discount'], 2)); ?> <?php echo e($currency); ?><br>
                      <?php echo app('translator')->getFromJson('admin/entries.total_paid_txt'); ?>: <?php echo e(number_format($sale['payments']->sum('amount'), 2)); ?> <?php echo e($currency); ?><br>
                      <?php echo app('translator')->getFromJson('admin/entries.amount_due_txt'); ?>: <?php echo e(number_format($sale['details2']->sum('amount') - $sale['discount'] - $sale['payments']->sum('amount'), 2)); ?> <?php echo e($currency); ?>

                    </p>

                    <button data-toggle="modal" data-target="#VoucherpaymentModal" data-id="<?php echo e($sale['id']); ?>" rel="tooltip" class="btn btn-danger btn-block new-btn"><?php echo app('translator')->getFromJson('admin/entries.add_payment_button'); ?></button>
                  </div>
                  ...
                  <?php if(isset($sale['payments']) && count($sale['payments']) > 0): ?>
                    <?php $__currentLoopData = $sale['payments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <div class="payment-detail">
                        <p>
                          <?php echo app('translator')->getFromJson('admin/entries.paid_amount_txt'); ?>: <?php echo e(number_format($payment->amount, 2)); ?> <?php echo e($currency); ?><br>
                          <?php echo app('translator')->getFromJson('admin/entries.account_label'); ?>: <?php echo e($payment->account->name); ?> <br>
