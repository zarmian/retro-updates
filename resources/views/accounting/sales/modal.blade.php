  <div class="modal-container">
    ...
    <form action="{{ url('accounting/sales/payment') }}" id="update" method="POST" data-toggle="validator">
    ...
    <div class="col-sm-11">
      ...
      <div class="col-sm-6 col-xs-5 col-md-6 col-lg-6 no-padding-left">
        <h4>@lang('admin/entries.customer_label'): {{ $sale['customer_name'] }} </h4>
      </div>

      <div class="col-sm-6 col-xs-5 col-md-6 col-lg-6 no-padding-right">
        <h4>@lang('admin/entries.invoice_no_txt'): {{ $sale['inv_no'] }} </h4>
      </div>

      <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 no-padding">
        <h4 class="fontsize13bold">@lang('admin/entries.invoice_sub_total_txt'): {{ $sale['sub_total'] }} </h4>
      </div>

      <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 no-padding">
        <h4 class="fontsize13bold">@lang('admin/entries.invoice_discount_txt'): {{ $sale['discount'] }} </h4>
      </div>

      <div class="col-sm-4 col-xs-4 col-md-4 col-lg-4 no-padding">
        <h4 class="fontsize13bold">@lang('admin/entries.invoice_total_txt'): {{ $sale['total'] }} </h4>
      </div>
      ...
      <div class="col-sm-12 form-group">
        <label for=""></label>
        <button type="submit" id="paidInvoice" class="btn btn-primary btn-block">@lang('admin/common.pay_button_txt')</button>
      </div>
