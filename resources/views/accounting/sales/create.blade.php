          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-xs-12 col-sm-offset-2">
            ...
            <div class="">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 form-group clearfix">
                  ...
                  <input type="text" name="invoice_date" id="invoice_date" class="form-control1 datepicker" placeholder="@lang('admin/entries.invoice_date_label')" required="required" value="{{ old('date') }}" data-min-year="{{ date('Y',time()) }}" data-max-year="{{ date('Y',strtotime('+10 year',time())) }}"/>
                </div>
                    ...
                    <input type="hidden" value="0" name="id" id="id">                    
                      <tr class="tr">
                        ...
                        <td class="col-desc" width="200">
                            <input type="text" value="" name="line_desc[]" id="line_desc[]" class="form-control1" placeholder="@lang('admin/entries.account_description_label')"  />
                        </td>
