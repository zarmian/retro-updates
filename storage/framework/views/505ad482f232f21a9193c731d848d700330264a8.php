...
<section class="breadcrumb">
  <div class="container">
    <div class="row">
      ...
      <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/entries.journal_heading_txt'); ?></a></div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      ...
      <form action="" method="GET">
        ...
        <input type="text" name="code" id="code" class="filter-date-input" placeholder="<?php echo app('translator')->getFromJson('admin/entries.entry_code_txt'); ?>" value="<?php echo e(\Request::get('code')); ?>"  />
       </div>
       ...
       <div class="col-lg-1 col-md-1 col-sm-2 col-xs-12 plus-margin">
        ...
        <a href="<?php echo e(url('accounting/journal/add')); ?>" class="plus">+</a></div>
      ...
      <div id="products" class="list-group">
        ...
        <?php $__currentLoopData = $journals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $journal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="col-lg-1 col-sm-12 col-xs-12 no-padding">
              ...
              <div class="col-sm-6 no-padding"><a href="<?php echo e(url('accounting/journal/detail/'.$journal['id'])); ?>" class="payment-btn-list btn-block btn-gray-bg"><i class="fa fa-eye" aria-hidden="true"></i></a>
              </div>
              <div class="col-sm-6 no-padding"><a href="<?php echo e(url('accounting/journal/edit/'.$journal['id'])); ?>" class="payment-btn-list btn-block btn-blue-bg"><i class="fa fa-edit" aria-hidden="true"></i></a></div>
