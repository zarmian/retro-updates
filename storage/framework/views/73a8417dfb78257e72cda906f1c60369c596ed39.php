...
<div style="height: 200px;">
  <div class="slim" data-label="Drop your cover photo here" data-service="<?php echo e(url('/profile/cover')); ?>" data-ratio="14:3">
         <?php if($user->cover <> NULL && file_exists(storage_path().'/app/covers/'.$user->cover)): ?>
          <img src="<?php echo e(asset('storage/app/covers/'.$user->cover)); ?>" alt="">
          <?php else: ?>
          <img src="<?php echo e(asset('storage/app/employees/covers/bg-solid-dark-grey.png')); ?>" alt="">
         <?php endif; ?>         
                    ...
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                        ...
                        <div class="">
                            ...
                            <select name="country_id" id="country_id" class="form-control1" required="required">
                                ...
                                <?php if(isset($countries) && count($countries) > 0): ?>
                                    <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($country->id == $user->country_id): ?>
                          ...
                          <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 col-xs-6 form-group no-padding-left">
                            ...
                            <input type="text" name="phone_no" id="phone_no" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/profile.phone_no_label'); ?>*" required="required" value="<?php echo e($user->phone_number); ?>" />
                          </div>

                          <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 col-xs-6 form-group no-padding">
                            <label for="mobile_no" class="input_label"><?php echo app('translator')->getFromJson('admin/profile.mobile_no_label'); ?>*</label>
                            <input type="text" name="mobile_no" id="mobile_no" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/profile.mobile_no_label'); ?>" value="<?php echo e($user->mobile); ?>" />
                          </div>
                          ...
                          <div class="col-sm-12 block no-padding top-margin-space">
                            <div class="col-sm-4">
                              ...
                              <div class="detail_area">
                                ...
                                <p><b><?php echo app('translator')->getFromJson('employees/common.country_txt'); ?>:</b> <?php echo e($user->countries->country_name); ?></p>
...
<script type="text/javascript" src="<?php echo e(asset('assets/slim/new.js')); ?>"></script>
