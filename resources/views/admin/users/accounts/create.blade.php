  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active">@lang('admin/users.create')</a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="col-sm-12 col-md-12 col-lg-12">
        @if(Session::has('msg'))
         ...
         <form data-toggle="validator" role="form" action="{{ url('manage-users/store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
            ...
            <div class="form_container">
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                    ...
                    <input type="text" name="cell" id="cell" class="form-control1" value="{{ old('cell') }}" required="required" placeholder="@lang('admin/users.cell_label')" />
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group">
                  <label for="present_address" class="input_label">@lang('admin/employees.present_address_label')*</label>
                  <input type="text" name="present_address" id="present_address" class="form-control1" placeholder="@lang('admin/users.present_address_label')" value="{{ old('present_address') }}"  />
                </div>

                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group">
                  <label for="present_address" class="input_label">@lang('admin/employees.permanant_address_label')*</label>
                  <input type="text" name="permanant_address" id="permanant_address" class="form-control1" placeholder="@lang('admin/users.permanant_address_label')" value="{{ old('permanant_address') }}" />
                </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
              ...
              <div class="form_container">
                ...
                <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4 form-group">
                  ...
                  <input type="text" name="employee_code" id="employee_code" readonly="readonly" class="form-control1" placeholder="@lang('admin/users.username_label')*" value="{{ $code }}" required="required">
                </div>

                <div class="col-md-8 col-sm-8 col-lg-8 col-xs-8 form-group">
                  <label for="username" class="input_label">@lang('admin/users.users_login_label')</label>
                  <input type="text" name="username" id="username" class="form-control1" placeholder="@lang('admin/users.username_label')*" value="{{ old('username') }}" required="required">
                </div>

                

                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                  <input type="password" name="password" id="password" class="form-control1" placeholder="@lang('admin/users.password_label')" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" required="required" data-bv-identical-field="password_confirmation" />
                </div>

                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                  <input type="password" name="password_confirmation" id="password_confirmation" class="form-control1" value="" required="required" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" data-bv-identical-field="password" data-bv-identical="true" placeholder="@lang('admin/users.c_password_label')" />
                </div>

                <div class="col-sm-12 form-group">
                  <label for="">@lang('admin/common.password_note')</label>
                </div>
