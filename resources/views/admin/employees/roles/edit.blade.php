...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      @endif
      <form id="group_form" method="post" class="registration-form" action="{{ url('/roles/update', $role->id) }}" style="margin-top: 20px;" enctype="multipart/form-data">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12">
            ...
            <div class="form_container">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding">
                ...
                <input type="text" name="title" id="title" class="form-control1" placeholder="@lang('admin/users.role_title_label')*" value="{{ $role->title }}" required="required" />
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group no-padding">
                ...
                <textarea name="description" id="description" cols="30" rows="10" class="form-control2" placeholder="@lang('admin/users.role_description_label')">{{ $role->description }}</textarea>
              </div>
                  ...
                  @if(isset($allowed_permissions[$permission->name]) && $allowed_permissions[$permission->name] == 'true')
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xs-12 permission_margin no-padding-left">
                      ...
                      <label class="btn permission_label active">
                        <input type="checkbox" name="permissions[{{$permission->name}}]" name="permissions[{{ $permission->name }}]" autocomplete="off" value="true" checked="checked" />
