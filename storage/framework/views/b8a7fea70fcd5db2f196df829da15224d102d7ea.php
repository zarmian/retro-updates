  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1><?php echo app('translator')->getFromJson('admin/reports.sales_payments_report_txt'); ?> </h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right"><a href="<?php echo e(url('/')); ?>"><?php echo app('translator')->getFromJson('admin/dashboard.dashboard-heading'); ?></a>  / <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/reports.sales_payments_report_txt'); ?></a></div>
    </div>
  </div>
</section>
<?php $__env->stopSection(); ?>
...
<section class="find-search hidden-print">
  <div class="container">
    ...
    <form action="<?php echo e(url('/reports/sales-payments')); ?>" method="post">
      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-10 no-padding">
          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 filter-input">
            <input type="text" name="voucher_no" id="voucher_no" class="filter-date-input" placeholder="<?php echo app('translator')->getFromJson('admin/reports.invoice_no_txt'); ?>" value="<?php echo e(app('request')->input('voucher_no')); ?>" />
           </div>
        ...
        <div class="ac_chart">
          ...
          <table class="table table-striped">
              ...
              <div class="col-sm-3 text-center pull-right hidden-print">
                ...
                <div class="col-sm-5 no-padding-left pull-right"><a href="<?php echo e(url("/reports/sales/export/?type=salesTransaction&to={$to}&from={$from}&customer={$customer_id}&voucher_no={$voucher_no}")); ?>" class="btn-default-xs btn-excel-bg btn-block"> <?php echo app('translator')->getFromJson('admin/reports.export_txt'); ?> &nbsp;&nbsp; <i class="fa fa-file-excel-o" aria-hidden="true"></i></a></div>
              </div>
               
                <tr>
                  <th width="150"><?php echo app('translator')->getFromJson('admin/entries.pay_serial_no_txt'); ?></th>
                  <th width="150"><?php echo app('translator')->getFromJson('admin/entries.invoice_no_txt'); ?></th>
