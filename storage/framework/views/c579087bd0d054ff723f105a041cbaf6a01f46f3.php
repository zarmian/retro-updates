...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      <form data-toggle="validator" role="form" method="post" class="registration-form"  action="<?php echo e(url('accounting/tax/edit', $department->id)); ?>" style="margin-top: 20px;" enctype="multipart/form-data">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12 col-sm-offset-3 col-md-offset-3 col-sm-offset-0">
            ...
            <div class="form_container">
              ...
              <div class="col-md-4 col-sm-4 col-lg-4 col-xs-12 form-group">
                ...
                <input type="text" name="title" id="title" class="form-control1" placeholder="Tax Name*" required="required" value="<?php echo e($department->name); ?>" />
              </div>

              <div class="col-md-4 col-sm-4 col-lg-4 col-xs-12 form-group">
                <label for="code" class="input_label">Tax Code</label>
                <input type="text" name="code" id="code" class="form-control1" placeholder="Tax Code*" required="required" value="<?php echo e($department->code); ?>" />
              </div>

              <div class="col-md-4 col-sm-4 col-lg-4 col-xs-12 form-group">
                <label for="rate" class="input_label">Tax Rate</label>
                <input type="text" name="rate" id="rate" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/departments.title'); ?>*" required="required" value="<?php echo e($department->rate); ?>" />
              </div>
