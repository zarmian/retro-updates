  ...
  <div class="container">
    <div class="row">
      ...
      <form action="" method="GET">
        ...
        <input type="text" name="name" id="name" class="filter-date-input" placeholder="@lang('admin/accounting.vendor_name')" value="{{ \Request::get('name') }}"  />
       </div>

       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <input type="text" name="email" id="email" class="filter-date-input"  placeholder="@lang('admin/accounting.vendor_email')" value="{{ \Request::get('email') }}" />
       </div>
       ...
       <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 plus-margin">
        ...
        <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 plus-margin"><a href="{{ url('accounting/vendors/add') }}" class="plus">+</a></div>
              ...
              <ul>
                   ...
                   <li class="">
                    ...
                    <ul>
                     ...
                     <div>
                        <a href="{{ url('accounting/vendors/edit/'.$customer->id) }}" data-toggle="tooltip"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>

                        <a href="{{ url('accounting/vendors/remove/'.$customer->id) }}" class="is_delete" data-toggle="tooltip"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>

                        <a href="{{ url('accounting/vendors/view/'.$customer->id) }}" data-toggle="tooltip"><span class="fa fa-list" aria-hidden="true"></span></a>
