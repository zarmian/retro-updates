  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1><?php echo app('translator')->getFromJson('admin/customers.create_customer_heading'); ?></h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/customers.create_customer_heading'); ?></a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="col-sm-12 col-md-12 col-lg-12">
        <?php if(Session::has('msg')): ?>
         ...
         <form data-toggle="validator" role="form" action="<?php echo e(url('accounting/customers/save')); ?>" method="POST" enctype="multipart/form-data">
          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-xs-12 col-sm-offset-2">
            ...
            <div class="form_container">
              ...
              <div class="col-md-2 col-sm-2 col-lg-2 col-xs-2 form-group">
                  ...
                  <input type="text" name="code" id="code" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/customers.code_label'); ?>*" required="required" value="<?php echo e($code); ?>" />
                </div>
