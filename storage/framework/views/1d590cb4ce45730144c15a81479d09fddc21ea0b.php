...
<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 top-margin-space-inv">
            ...
            <div class="inv-block clearfix">
            	...
            	<table width="100%">
                    ...
                    <h1 style="font-size: 18px;"><?php echo app('translator')->getFromJson('admin/entries.invoice_no_txt'); ?>: <?php echo e($sale['inv_no']); ?></h1>
                  ...
                  <div class="invoice-detail">
                    ...
                    <p>
                      <?php echo app('translator')->getFromJson('admin/entries.invoice_date_label'); ?>: <?php echo e($sale['inv_date']); ?> <br>
              ...
              <div class="invoice-top-space clearfix">
                    ...
                    <?php if(isset($sale['details']) && count($sale['details'])): ?>
                      <?php $__currentLoopData = $sale['details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td class="td-dark-gray text-center" style="background: #efefef !important"><b><?php echo e($detail['unit_price']); ?></b></td>
                          <td class="td-light-gray text-center" style="background: #f5f5f5 !important;"><b><?php echo e($detail['amount']); ?></b></td>
                        </tr>
                ...
                <div class="">
                 <table class="table table-bordered total_cal" width="300" style="width: 300px !important" id="total_cal" align="right">
                   <tr>
                     <td width="150" height="30" class="text-right" style="padding-right: 20px;"><?php echo app('translator')->getFromJson('admin/entries.sub_total_txt'); ?></td>
                     <td style="padding-left: 20px;"><?php echo e($sale['unit_price']); ?></td>
                   </tr>

                   <tr>
                     <td style="padding-right: 20px;" height="30" class="text-right"><?php echo app('translator')->getFromJson('admin/entries.discount_txt'); ?></td>
                     <td style="padding-left: 20px;"><?php echo e($sale['discount']); ?></td>
                   </tr>

                   <tr>
                     <td style="padding-right: 20px;" height="30" class="text-right"><?php echo app('translator')->getFromJson('admin/entries.total_txt'); ?></td>
                     <td style="padding-left: 20px;"><?php echo e($sale['total']); ?></td>
                   </tr>

                   <tr>
                     <td style="padding-right: 20px;" height="30" class="text-right"><?php echo app('translator')->getFromJson('admin/entries.total_paid_txt'); ?></td>
                     <td style="padding-left: 20px;"><?php echo e($sale['tlt_paid_sum']); ?></td>
                   </tr>
                   ...
                   <tr>
                     ...
                     <td style="padding-left: 20px;"><?php echo e($sale['due_amount']); ?></td>
                   </tr>
                 </table>
               </div>
              </div>
