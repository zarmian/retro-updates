  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        ...
        <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/leaves.update_offical_heading'); ?></a>
      </div>
    </div>
  </div>
</section>
...
<div class="container mainwrapper margin-top">
  <div class="row">
    <div class="container">
      ...
      <form data-toggle="validator" role="form" method="post" class="registration-form"  action="<?php echo e(url('/official-leaves/update', $leave->id)); ?>" style="margin-top: 20px;" enctype="multipart/form-data">
          ...
          <div class="col-sm-12 col-md-6 col-lg-6 col-xs-12 col-sm-offset-3 col-md-offset-3 col-sm-offset-0">
            ...
            <div class="form_container">
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding-left">
                ...
                <input type="text" name="title" id="title" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/leaves.title'); ?>*" required="required" value="<?php echo e($leave->title); ?>" />
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding">
                ...
                <select name="status" id="status" class="form-control1" required="required">
                  <option value="1" <?php if($leave->status == 1): ?> selected="selected" <?php endif; ?>>Active</option>
                  <option value="0" <?php if($leave->status == 0): ?> selected="selected" <?php endif; ?>>InActive</option>
                </select>
              </div>
              ...
              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding-left">
                ...
                <input type="text" name="start_date" id="start_date" class="datepicker form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/leaves.start_date'); ?>*" required="required" data-default-date="<?php echo e(date('m/d/Y', strtotime($start_date->leave_date))); ?>" data-format="m/d/Y" />
              </div>

              <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group no-padding">
                <label for="end_date" class="input_label"><?php echo app('translator')->getFromJson('admin/leaves.end_date'); ?></label>
                <input type="text" name="end_date" id="end_date" class="datepicker form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/leaves.end_date'); ?>*" required="required" data-default-date="<?php echo e(date('m/d/Y', strtotime($end_date->leave_date))); ?>" data-format="m/d/Y" />
              </div>
