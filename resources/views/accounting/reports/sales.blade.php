  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1>@lang('admin/reports.sales_report_txt') </h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right"><a href="{{ url('/') }}">@lang('admin/dashboard.dashboard-heading')</a>  / <a href="#" class="active">@lang('admin/reports.sales_report_txt')</a></div>
    </div>
  </div>
</section>
@endsection
        ...
        <div class="ac_chart">
          ...
          <table class="table table-striped">
              ...
              <div class="col-sm-3 text-center pull-right hidden-print">
                ...
                <div class="col-sm-5 no-padding-left pull-right"><a href="{{ url("/reports/sales/export/?type=salesReport&to={$to}&from={$from}&customer={$customer_id}&by_type={$by_type}&due_date={$due_date}") }}" class="btn-default-xs btn-excel-bg btn-block"> @lang('admin/reports.export_txt') &nbsp;&nbsp; <i class="fa fa-file-excel-o" aria-hidden="true"></i></a></div>
              </div>
                ...
                @foreach($sales as $sale)
                  ...
                  <tr>
                    <th><a href="{{ url('accounting/sales/detail', $sale['id']) }}"><b>{{ $sale['invoice_number'] }} </b></a></th>
