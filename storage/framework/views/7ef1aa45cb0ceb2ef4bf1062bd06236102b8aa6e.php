          ...
          <div class="thumbnail">
            <div class="row">
                ...
                <ul class="inner-btn clearfix">
                  ...
                  <li><a href="<?php echo e(url('accounting/products/delete/'.$item['id'])); ?>" data-toggle="tooltip" title="Delete" class="is_delete"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></li>
                </ul>
