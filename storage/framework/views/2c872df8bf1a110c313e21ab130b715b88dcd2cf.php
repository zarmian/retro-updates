...
<section class="breadcrumb hidden-print">
  <div class="container">
    <div class="row">
      ...
      <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/entries.journal_view_txt'); ?></a>  
      </div>
    </div>
  </div>
</section>
            ...
            <div class="inv-block clearfix">
              ...
              <div class="col-sm-6 col-lg-6 col-md-6 col-xs-6 hidden-print">
                <div class="inv-no-heading">
                  <h2><?php echo app('translator')->getFromJson('admin/entries.entry_no_txt'); ?>: <?php echo e($journal['code']); ?></h2>
                </div>
              </div>
              ...
              <div class="invoice-top-space clearfix">
                ...
                <div class="text-right">
                  ...
                  <div class="invoice-detail">
                    <h4><?php echo app('translator')->getFromJson('admin/entries.journal_detail_txt'); ?></h4>
                    <p>
