  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <h1><?php echo app('translator')->getFromJson('admin/vendors.create_customer_heading'); ?></h1>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
        <a href="<?php echo e(url('/')); ?>"><?php echo app('translator')->getFromJson('admin/dashboard.dashboard-heading'); ?></a>  / 
        <a href="<?php echo e(url('accounting/vendors')); ?>"><?php echo app('translator')->getFromJson('admin/vendors.manage_heading'); ?></a>  / 
        <a href="#" class="active"><?php echo app('translator')->getFromJson('admin/vendors.create_customer_heading'); ?></a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="container">
      <div class="col-sm-12 col-md-12 col-lg-12">
        <?php if(Session::has('msg')): ?>
         ...
         <form data-toggle="validator" role="form" action="<?php echo e(url('accounting/vendors/save')); ?>" method="POST" enctype="multipart/form-data">
          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-xs-12 col-sm-offset-2">
            <div class="top_content">
              <h3><?php echo app('translator')->getFromJson('admin/vendors.person_detail_heading'); ?></h3>
            ...
            <div class="form_container">
                 ...
                 <div class="col-md-2 col-sm-2 col-lg-2 col-xs-2 form-group">
                  <label for="code" class="input_label"><?php echo app('translator')->getFromJson('admin/vendors.code_label'); ?></label>
                  <input type="text" name="code" id="code" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/vendors.code_label'); ?>*" required="required" value="<?php echo e($code); ?>" />
                </div>
                ...
                <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4 form-group">
                  ...
                  <input type="text" name="company" id="company" class="form-control1" value="<?php echo e(old('company')); ?>" placeholder="<?php echo app('translator')->getFromJson('admin/customers.company_label'); ?>" />
                </div>
                ...
                <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4 form-group">
                    ...
                    <input type="text" name="mobile" id="mobile" class="form-control1" value="<?php echo e(old('mobile')); ?>" placeholder="<?php echo app('translator')->getFromJson('admin/users.cell_label'); ?>" />
                </div>


                <div class="col-md-4 col-sm-4 col-lg-4 col-xs-4 form-group">
                  <label for="fax" class="input_label"><?php echo app('translator')->getFromJson('admin/users.fax_label'); ?></label>
                  <input type="text" name="fax" id="fax" value="<?php echo e(old('fax')); ?>" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/users.fax_label'); ?>">
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                  ...
                  <input type="text" name="present_address" id="present_address" value="<?php echo e(old('present_address')); ?>" required="required" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/users.present_address_label'); ?>*">
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xs-6 form-group">
                  ...
                  <input type="text" name="permanent_address" id="permanent_address" value="<?php echo e(old('permanent_address')); ?>" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/users.permanant_address_label'); ?>">
                </div>
                ...
                <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group">
                  ...
                  <input type="text" name="state" id="state" value="<?php echo e(old('state')); ?>"  class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/users.state_label'); ?>">
                </div>


                <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group">
                  <label for="city" class="input_label"><?php echo app('translator')->getFromJson('admin/users.city_label'); ?></label>
                  <input type="text" name="city" id="city" value="<?php echo e(old('city')); ?>" class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/users.city_label'); ?>">
                </div>


                <div class="col-md-3 col-sm-3 col-lg-3 col-xs-3 form-group">
                  <label for="postal_code" class="input_label"><?php echo app('translator')->getFromJson('admin/users.postal_label'); ?></label>
                  <input type="text" name="postal_code" id="postal_code" value="<?php echo e(old('postal_code')); ?>"  class="form-control1" placeholder="<?php echo app('translator')->getFromJson('admin/users.postal_label'); ?>">
                </div>
