...
<section class="breadcrumb">
  <div class="container">
    <div class="row">
      ...
      <a href="#" class="active">@lang('admin/entries.sales_heading_txt')</a></div>
    </div>
  </div>
</section>
@endsection
    ...
    <div class="row">
      ...
      <form action="" method="GET">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
          <input type="text" name="invoice_no" id="invoice_no" class="filter-date-input" placeholder="@lang('admin/accounting.enter_inovice_no_txt')" value="{{ \Request::get('invoice_no') }}"  />
        </div>
      ...
      <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 plus-margin"><a href="{{ url('accounting/sales/add') }}" class="plus">+</a></div>
      ...
      <div id="products" class="list-group">
        ...
        @foreach($sales as $sale)
            ...
            <div class="col-lg-11 col-md-12 col-sm-12 col-xs-12 list-content-row">
              ...
              <div class="col-sm-12 no-padding">
                <ul class="clearfix">
                  ...
                  <li>@lang('admin/entries.invoice_number_txt'): <b> @lang('admin/common.inv_prefix') {{ $sale['invoice_number'] }} </b></li>
                  <li>@lang('admin/entries.customer_label'): <b>{{ $sale['customer_name'] }}</b></li>
                  <li>@lang('admin/entries.invoice_date_label'): <b>{{ $sale['invoice_date'] }}</b></li>
                  <li>@lang('admin/entries.invoice_due_date_label'): <b>{{ $sale['due_date'] }}</b></li>
                  <li>@lang('admin/entries.tlt_txt'): <b> {{ $sale['total'] }}</b></li>
                  <li>
          ...
          <div class="col-lg-1 col-md-12 col-sm-12 col-xs-12 no-padding">
              ...
              <div class="col-sm-6 no-padding"><a href="{{ url('accounting/sales/detail/'.$sale['id']) }}" class="payment-btn-list btn-block btn-gray-bg"><i class="fa fa-eye" aria-hidden="true"></i></a>
              </div>
              <div class="col-sm-6 no-padding"><a href="{{ url('accounting/sales/edit/'.$sale['id']) }}" class="payment-btn-list btn-block btn-blue-bg"><i class="fa fa-edit" aria-hidden="true"></i></a></div>
