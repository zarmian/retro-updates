            ...
            <li class="dropdown">
              ...
              <?php endif; ?>
                ...
                <li class="dropdown-submenu"><a href="#">Payment Recieve</a>
                  <ul class="dropdown-menu">
              <?php if(Auth::guard('auth')->user()->hasRole('PURCHASE')): ?>
                <li><a href="<?php echo e(url('accounting/payments/received/add')); ?>">Add Receive Voucher</a></li>
                <li><a href="<?php echo e(url('accounting/payments/received')); ?>">Payment Receive Voucher</a></li>
              <?php endif; ?>
                  </ul>
                </li>
                ...
                <li class="dropdown-submenu"><a href="#">Payment Send</a>
                  <ul class="dropdown-menu">
              <?php if(Auth::guard('auth')->user()->hasRole('PURCHASE')): ?>
                <li><a href="<?php echo e(url('accounting/payments/send/add')); ?>">Add Send Voucher</a></li>
                <li><a href="<?php echo e(url('accounting/payments/send')); ?>">Payment Send Voucher</a></li>
              <?php endif; ?>
                  </ul>
                </li>
